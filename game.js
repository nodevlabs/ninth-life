  ...
  function calcScore(cats, fams, fLvl, cfx = {}, ctx = {}) {
    ...
    if (!cfx.noTraits && grudges.length > 0) {
      grudges.forEach(([a, b]) => {
        ...
        bd.push({ label: `\u26A1 ${a.name.split(" ")[0]}+${b.name.split(" ")[0]} Tension${ctx._grudgeDouble ? " \xD72" : ""}`, chips: 0, mult: grudgePenalty, type: "grudge_tension", catIdxs: [cats.indexOf(a), cats.indexOf(b)] });
      });
    }
    {
      const bondedPairs = [];
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null,
          /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 4 } },
            ...
            totalLevels > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", gap: 12, marginTop: 6, alignItems: "center" } },
              ...
              }, style: { fontSize: 9, color: "#ef444466", cursor: "pointer" } }, "respec"))
          ),
          branches.map((br) => {
