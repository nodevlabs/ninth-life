(() => {
  ...
  const FAMS = [
    ...
    { id: "f5", name: "Golden Yarn", icon: "\u{1F9F6}", desc: "+15 to base score per cat", eff: (c) => ({ chips: c.length * 15 }) },
    ...
    { id: "f24", name: "Bench Coach", icon: "\u{1FA91}", desc: "+2 to multiplier per unplayed cat", eff: (c, ctx) => ({ mult: (ctx?.benchSize || 0) * 2 }) },
  ...
  function resolveDen(denCats, hasMatchmaker, denSafe, heatDenFight, ctx = {}) {
    ...
    for (let i = 0; i < cats.length; i++) {
      ...
      for (let j = i + 1; j < cats.length; j++) {
        ...
        if (moodMod < 30) a.fightCh = Math.min(80, a.fightCh + 10);
  ...
  function _CC({ cat: _cat, sel, onClick, sm, cw: _cw, dis, hl, fog, chemHint, denMode, onTraitClick }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      (cat2.injured || cat2.scarred || cat2.bondedTo || (cat2.grudgedWith || []).length > 0 || cat2.parentIds?.length > 0 || cat2._hearthChild) && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 0, left: 0, right: 0, zIndex: 5, display: "flex", gap: 0, justifyContent: "center" } }, cat2._hearthChild && /* @__PURE__ */ React.createElement("div", { title: "Hearth Legend: returned to guide this colony. Cannot be saved back.", style: {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 0, left: 0, right: 0, zIndex: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", height: sm ? 14 : 18 } }, /* @__PURE__ */ React.createElement("div", { style: {
        ...
        lineHeight: 1,
        zIndex: 1
      } }, isWild ? "\u2726" : b.icon)), /* @__PURE__ */ React.createElement("div", { style: { background: "#0d1117", padding: sm ? "1px 4px 4px" : "2px 8px 5px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: {
        fontSize: xs ? 7 : sm ? fn.length > 7 ? 8 : fn.length > 5 ? 9 : 10 : fn.length > 8 ? 10 : fn.length > 6 ? 11 : 13,
        fontWeight: 700,
        color: neon,
        letterSpacing: xs ? 0 : sm ? 0 : fn.length > 7 ? 1 : 3,
  ...
  function NinthLife() {
    ...
    function pickDraft(i) {
      ...
      if (picked.length >= maxPicks) {
        ...
        if (!isFirstEverRun) {
          setBabyNamingQueue(picked.slice(1));
    ...
    function checkHandDiscovery(htName, comboName) {
      ...
      if (discoveries.length > 0) {
        ...
        Audio.tierReveal(4);
        if (discoveries.includes("Kindred")) setTimeout(() => toast("\u{1F4A1}", "Kindred: 3+ cats with the same trait. Build toward it in the den and shop.", "#c084fc", 5e3), 2e3);
      }
    }
    ...
    function discardH() {
      ...
      if (Math.random() < 0.15 && d.length > 0) {
        ...
        if (whisper) toast("", whisper, "#ffffff33", 2e3);
      }
      let extraDraw = [];
      let healIds = [];
      let powerUps = {};
    ...
    function genShop() {
      ...
      for (let i = 0; i < nc; i++) {
        const biasBreed = i === 1 && dominantSeason && dominantSeason[1] >= 5 && Math.random() < 0.5 ? dominantSeason[0] : null;
        const c = gC(i === 0 ? { trait: pickTrait(ante >= 3) } : biasBreed ? { breed: biasBreed, trait: PLAIN } : { trait: PLAIN });
    ...
    *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
    ...
    if (ph === "firstIntro") {
      const pages = [
        ...
        () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 56, animation: "float 3s ease-in-out infinite", filter: "drop-shadow(0 0 30px #fbbf2444)" } }, "\u{1F525}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, fontWeight: 900, color: "#fbbf24", letterSpacing: 6, animation: "fadeIn .8s ease-out", textShadow: "0 0 30px #fbbf2433" } }, "THE LAST HEARTH"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ffffffbb", textAlign: "center", maxWidth: 320, lineHeight: 2.2, animation: "fadeIn 1.2s ease-out" } }, "A fire still burns. Cats are gathering."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ffffff88", textAlign: "center", maxWidth: 300, lineHeight: 1.9, animation: "fadeIn 1.8s ease-out" } }, "Strays. Fighters. Survivors.", /* @__PURE__ */ React.createElement("br", null), "They need someone to remember their names."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#fbbf24cc", textAlign: "center", maxWidth: 320, lineHeight: 1.8, animation: "fadeIn 2.5s ease-out", marginTop: 8, fontWeight: 600 } }, "That's you.", /* @__PURE__ */ React.createElement("br", null), "Keep the fire burning.")),
        ...
        })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: "#4ade80", letterSpacing: 3, animation: "fadeIn .8s ease-out", textShadow: "0 0 20px #4ade8033" } }, "ONE RULE"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#ffffffcc", textAlign: "center", maxWidth: 320, lineHeight: 2, animation: "fadeIn 1.2s ease-out" } }, "Same-season cats resonate.", /* @__PURE__ */ React.createElement("br", null), "They score better together."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff55", textAlign: "center", maxWidth: 320, lineHeight: 1.7, animation: "fadeIn 1.8s ease-out", marginTop: 4 } }, "Match seasons. Build hands. Beat the target.", /* @__PURE__ */ React.createElement("br", null), "The rest, the dark will teach you."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#fbbf2466", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.8, animation: "fadeIn 2.5s ease-out 0.5s both", marginTop: 12, padding: "10px 16px", borderRadius: 10, background: "#ffffff04", border: "1px solid #ffffff08" } }, "Three cats need a name. Choose well."))
      ];
    ...
    if (ph === "draft") {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 14, padding: 20, maxWidth: 500 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 4, animation: "fadeIn .5s ease-out" } }, hasHearthLineage ? "DESCENDANTS OF THE HEARTH" : "THE GATHERING"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, [0, 1, 2].map((i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          c._hearthParents && /* @__PURE__ */ React.createElement("div", { style: { color: "#c084fc", fontSize: 10, fontStyle: "italic", lineHeight: 1.3, marginTop: 1 } }, "child of ", c._hearthParents, ".", " ", c._parentTrait && c.trait.name === c._parentTrait ? /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24" } }, "Carries the same fire.") : c._parentTrait ? /* @__PURE__ */ React.createElement("span", { style: { color: "#c084fc88" } }, "Something different in the eyes.") : null),
    ...
    if (ph === "nightCard" && nightCard) {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: {
        ...
        marginBottom: 2
      } }, blindNames[nightCard.blind].toUpperCase()), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 1, background: `linear-gradient(90deg,transparent,${glowColor}33)` } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ffffff55", letterSpacing: 8 } }, "NIGHT ", nightCard.ante), /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 1, background: `linear-gradient(90deg,${glowColor}33,transparent)` } })), isBoss2 && boss && /* @__PURE__ */ React.createElement("div", { style: {
        display: "flex",
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, showWhisper && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 2s ease-out .5s both", marginTop: 8 } }, wLine), narLine && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#c084fc55", fontStyle: "italic", textAlign: "center", maxWidth: 320, lineHeight: 1.6, animation: "fadeIn 2.5s ease-out 1s both", marginTop: showWhisper ? 4 : 8, padding: "6px 12px", borderRadius: 8, background: "#c084fc06", border: "1px solid #c084fc11" } }, narLine), (() => {
          ...
          if (neverPlayed.length >= 2) return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff22", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 3s ease-out 1.5s both", marginTop: 4 } }, neverPlayed.map((c) => c.name.split(" ")[0]).join(" and "), " ", neverPlayed.length === 2 ? "haven't" : "haven't", " played a single hand. They're starting to wonder why they're here.");
          if (overPlayed.length === 1) return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff22", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 3s ease-out 1.5s both", marginTop: 4 } }, "The same hand again. ", overPlayed[0].name.split(" ")[0], " carries every hand. The others watch.");
          if (fallen.length > 3) return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff22", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 3s ease-out 1.5s both", marginTop: 4 } }, "The colony is lighter. Nobody says whether that's freedom or loss.");
          return null;
        })());
        ...
        } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: `${glowColor}66`, letterSpacing: 3, marginBottom: 4 } }, "TARGET"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: glowColor, textShadow: `0 0 20px ${glowColor}33` } }, ncTgt.toLocaleString())), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: "#ffffff08" } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#3b82f688", letterSpacing: 3, marginBottom: 4 } }, "HANDS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: "#3b82f6" } }, hLeft)), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: "#ffffff08" } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444488", letterSpacing: 3, marginBottom: 4 } }, "DISCARDS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: "#ef4444" } }, ncDiscs)));
      })(), isFirstEver && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#4ade80bb", animation: "fadeIn 2s ease-out .8s both", marginTop: 12 } }, "Tap cats ", "\u2192", " Play Hand ", "\u2192", " Beat ", ncTgt.toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", marginTop: 20, animation: `fadeIn 2s ease-out ${isFirstEver ? 1.2 : 0.6}s both` } }, "tap to begin")));
    }
    ...
    if (ph === "title") {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement(Dust, null), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 10, right: 10, zIndex: 200, display: "flex", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55", letterSpacing: 1 } }, "v0.7"), meta && meta.stats.r >= 1 && /* @__PURE__ */ React.createElement("button", { onClick: async () => {
        const sums = [];
...
Saved from Night ${c.fromAnte || "?"}`, style: {
    ...
    if (ph === "event" && colEvent) {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: "12%", left: "50%", transform: "translateX(-50%)", width: 350, height: 350, borderRadius: "50%", background: `radial-gradient(circle,${evtGlow}06,transparent 70%)`, pointerEvents: "none", zIndex: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 0, padding: 20, maxWidth: 480 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", letterSpacing: 8, marginBottom: 16, animation: "fadeIn 1.2s ease-out", textTransform: "uppercase" } }, "Night ", ante, " ", "\xB7", " ", ["Dusk", "Midnight", "After the Boss"][blind]), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 64, marginBottom: 8, animation: "fadeIn .6s ease-out", filter: `drop-shadow(0 0 40px ${evtGlow}22)` } }, evt.icon), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 20, color: "#e8e6e3", letterSpacing: 6, margin: "0 0 6px 0", fontWeight: 600, animation: "fadeIn .8s ease-out" } }, evt.title), evt.tag && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: evtGlow + "66", letterSpacing: 4, padding: "3px 12px", borderRadius: 12, border: `1px solid ${evtGlow}15`, marginBottom: 16, animation: "fadeIn 1s ease-out", textTransform: "uppercase" } }, evt.tag), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#c8c2bbdd", textAlign: "center", lineHeight: 2.1, maxWidth: 360, fontStyle: "italic", animation: "fadeIn 1.2s ease-out", marginBottom: 16, padding: "0 8px" } }, evtText), meta && meta.cats.length > 0 && tgts.length > 0 && (() => {
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, allCount, " cats"), scarCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fb923c77" } }, scarCount, " scarred"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fbbf24", fontWeight: 700 } }, gold, "\u{1F41F}"));
      })())));
    }
    ...
    if (ph === "overflow" && oData) {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { ...W, animation: clutch ? "flash .6s ease-out" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), clutch && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 50, background: "radial-gradient(circle,#fbbf2433,transparent 70%)", pointerEvents: "none", animation: "flash 1.5s ease-out" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 10, padding: 20 } }, clutch && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 900, color: "#fbbf24", letterSpacing: 8, textShadow: "0 0 30px #fbbf24cc", animation: "clutchBurst .8s ease-out", marginBottom: 4 } }, "CLUTCH"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: blind >= 2 ? "#4ade80" : "#fbbf24", letterSpacing: 3 } }, blind >= 2 ? clutch ? "Survived. Barely." : "Survived." : "Cleared."), clearLine && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ffffffbb", fontStyle: "italic", textAlign: "center", maxWidth: 320, lineHeight: 1.6, animation: "fadeIn 1.2s ease-out", textShadow: "0 0 15px #ffffff11" } }, clearLine), blind >= 2 && boss && (() => {
        ...
        gap: 2,
        minWidth: 100
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F3EA}"), /* @__PURE__ */ React.createElement("span", null, isFirstRun && !seen.shop ? "Enter the Market \u2726" : "Market"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6 } }, "buy wards, cats, scrolls")), (seen.shop || !isFirstRun) && /* @__PURE__ */ React.createElement("button", { onClick: () => {
        const baseG = 3 + ante;
        const results = [];
        let bonusG = 0;
        ...
        gap: 2,
        minWidth: 100
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F33F}"), /* @__PURE__ */ React.createElement("span", null, "Scavenge"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6 } }, "+", 3 + ante, "\u{1F41F}, maybe more")), (seen.shop || !isFirstRun) && /* @__PURE__ */ React.createElement("button", { onClick: () => {
        if (gold < 3) {
      ...
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F3D5}"), /* @__PURE__ */ React.createElement("span", null, "Camp"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6 } }, gold >= 3 ? "3\u{1F41F}, rest + watch" : "Need 3\u{1F41F}"))))));
    }
    if (ph === "defeat" && defeatData) {
      ...
      const defSentence = deficit > 0 && deficit < defeatData.target * 0.1 ? `${defMvpN}'s best hand: ${(defMvp?.stats?.bs || 0).toLocaleString()}. The colony needed ${deficit.toLocaleString()} more. That close. That's the whole story.` : fallen.length > 0 && defBonds.length > 0 ? `${fallen.map((f) => f.name.split(" ")[0]).join(", ")} fell. ${defBonds[0].name.split(" ")[0]} bonded with someone who won't see dawn. The dark doesn't negotiate.` : defEpithets.length > 0 ? `${defEpithets[0].name.split(" ")[0]} ${defEpithets[0].epithet} survived. The title outlived the colony. ${deficit > 0 ? deficit.toLocaleString() + " short." : ""}` : defMvp && (defMvp.stats?.tp || 0) > 5 ? `${defMvpN} played ${defMvp.stats.tp} hands. Scored ${(defMvp.stats?.bs || 0).toLocaleString()} at their best. It wasn't enough. ${deficit > 0 ? deficit.toLocaleString() + " short." : ""}` : fallen.length > 0 ? `${fallen.length} name${fallen.length > 1 ? "s" : ""} lost before the end. ${fallen[0].name.split(" ")[0]} went first. The rest followed the silence.` : `Night ${ante}. ${allC.length} cats. ${defeatData.score.toLocaleString()} scored. ${deficit > 0 ? deficit.toLocaleString() + " short of mattering." : "Not enough."}`;
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 16, padding: 20, maxWidth: 500 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 64, opacity: 0.6, animation: "fadeIn 1s ease-out", filter: "drop-shadow(0 0 30px #ef444488)" } }, "\u{1F480}"), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 28, color: "#ef4444", letterSpacing: 6, margin: 0, textShadow: "0 0 40px #ef444444", animation: "tierReveal 1s ease-out" } }, "COLONY FELL"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, color: "#ef4444aa", fontStyle: "italic", textAlign: "center", maxWidth: 360, lineHeight: 1.7, animation: "fadeIn 1.5s ease-out" } }, defeatData.line), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ef4444aa", textAlign: "center", maxWidth: 360, lineHeight: 1.7, animation: "fadeIn 2s ease-out", padding: "10px 16px", borderRadius: 10, background: "#ef444408", border: "1px solid #ef444418" } }, defSentence), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, fontSize: 13, color: "#666", animation: "fadeIn 2s ease-out" } }, /* @__PURE__ */ React.createElement("span", null, "Night ", ante), /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, defeatData.blind)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, alignItems: "baseline", animation: "fadeIn 2s ease-out" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 28, fontWeight: 900, color: "#ef4444bb" } }, defeatData.score.toLocaleString()), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "#666" } }, " / ", defeatData.target.toLocaleString(), " target")), fallen.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center", animation: "fadeIn 2.5s ease-out" } }, fallen.map((f, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { fontSize: 10, color: BREEDS[f.breed]?.color || "#888", opacity: 0.5 } }, f.name.split(" ")[0]))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
        setDefeatData(null);
        setPh("gameOver");
    ...
    if (ph === "gameOver" || ph === "victory") {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 12, padding: 20, maxWidth: 550 } }, vStep === 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, animation: "comboBurst .8s ease-out" } }, won ? isNinthDawn ? "\u{1F305}" : "\u{1F451}" : "\u{1F480}"), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: won && isNinthDawn ? 48 : 32, letterSpacing: won && isNinthDawn ? 16 : 8, margin: 0, color: won ? void 0 : "#ef4444", background: won ? "linear-gradient(180deg,#fef08a,#fbbf24)" : void 0, WebkitBackgroundClip: won ? "text" : void 0, WebkitTextFillColor: won ? "transparent" : void 0, animation: "comboBurst .6s ease-out", fontWeight: 700, textTransform: "uppercase", filter: won ? "drop-shadow(0 0 20px #fbbf2433)" : "none" } }, won ? isNinthDawn ? "DAWN" : "THEY MADE IT" : "THE DARK WON"), won && !isNinthDawn && (() => {
        ...
        const cx = cw / 2;
        const cy = ch / 2;
        const dotSize = vw < 500 ? 8 : 6;
        const nameSize = vw < 500 ? 10 : 8;
        ...
        })())), pts.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.c.id, style: { position: "absolute", left: p.x - dotSize / 2, top: p.y - dotSize / 2, width: dotSize, height: dotSize, borderRadius: "50%", background: BREEDS[p.c.breed]?.color || "#fbbf24", boxShadow: `0 0 ${dotSize + 2}px ${BREEDS[p.c.breed]?.color || "#fbbf24"}66`, animation: `fadeIn .5s ease-out ${1.5 + p.i * 0.15}s both` }, title: p.c.name.split(" ")[0] })), pts.map((p) => /* @__PURE__ */ React.createElement("div", { key: `n${p.c.id}`, style: { position: "absolute", left: p.x - 24, top: p.y + dotSize, width: 48, fontSize: nameSize, textAlign: "center", color: BREEDS[p.c.breed]?.color || "#fbbf2466", fontWeight: 600, animation: `fadeIn .5s ease-out ${2 + p.i * 0.15}s both`, lineHeight: 1.2 } }, p.c.name.split(" ")[0], p.c.epithet ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: nameSize - 2, color: "#fbbf2444", fontWeight: 400 } }, p.c.epithet) : null)));
    ...
    if (ph === "denResults" && denRes) {
      ...
      denRes.forEach((r) => {
        ...
        if (r.type === "fight") beats.push({ pri: 3, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, color: "#ef4444", lineHeight: 1.4, padding: "4px 0" } }, "\u2694 ", n(r.loser), " ", r.wasInjured ? "injured" : "scarred", " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "(", r.wasInjured ? "heals in 2 rounds" : "\xD71.25 mult", ")")) });
        ...
        if (r.type === "growth") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, color: "#4ade80", lineHeight: 1.4, padding: "4px 0" } }, "\u2B50 ", n(r.cat), " +1P") });
        ...
        if (r.type === "training") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, color: "#60a5fa", lineHeight: 1.4, padding: "4px 0" } }, "\u2694\uFE0F ", n(r.c1), " & ", n(r.c2), " sparred ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, ": +1P each")) });
    ...
    if (ph === "shop") {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement(Dust, null), /* @__PURE__ */ React.createElement("style", null, CSS), toasts.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 250, display: "flex", flexDirection: "column", gap: 6, pointerEvents: "none", maxWidth: 280 } }, toasts.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", gap: 8, alignItems: "center", padding: t.big ? "12px 18px" : "8px 14px", borderRadius: t.big ? 10 : 8, background: "#1a1a2eee", border: `1.5px solid ${t.color}${t.big ? "66" : "44"}`, boxShadow: `0 4px 16px #00000066,0 0 ${t.big ? 16 : 8}px ${t.color}${t.big ? "44" : "22"}`, animation: `${t.neg ? "slideInLeft" : "slideInRight"} .3s ease-out` }, className: t.neg ? "toast-enter-neg" : "toast-enter" }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 22 : 16, flexShrink: 0 } }, t.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 14 : 12, color: t.color, fontWeight: t.big ? 700 : 600, lineHeight: 1.3 } }, t.text)))), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 700, padding: "10px 16px", zIndex: 1, display: "flex", flexDirection: "column", gap: 8, alignItems: "center", paddingBottom: 100 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", width: "100%", alignItems: "center" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 20, color: "#fbbf24", letterSpacing: 4, margin: 0 } }, "THE MARKET"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, fontWeight: 900, color: "#fbbf24" } }, gold, " \u{1F41F}"), /* @__PURE__ */ React.createElement(ProgressMap, { ante, blind, mx: MX }))), /* @__PURE__ */ React.createElement(FM, { level: ferv, prev: pFerv }), (() => {
        ...
        const hasSynergy = (() => {
          ...
          if (f.id === "f15") return colCats2.filter((c) => c.scarred).length >= 2;
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { ...W, animation: fFlash === "down" ? "shake .3s ease" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), isNL && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, border: "2px solid #fef08a44", pointerEvents: "none", zIndex: 50, animation: "glow 2s ease-in-out infinite" } }), reshuf && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: "40%", left: "50%", transform: "translate(-50%,-50%)", zIndex: 200, animation: "flash .8s ease-out forwards", fontSize: 13, color: "#fbbf24", letterSpacing: 4, fontWeight: 700, whiteSpace: "nowrap" } }, "\u267B RESHUFFLE"), toasts.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 250, display: "flex", flexDirection: "column", gap: 6, pointerEvents: "none", maxWidth: 280 } }, toasts.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", gap: 8, alignItems: "center", padding: t.big ? "12px 18px" : "8px 14px", borderRadius: t.big ? 10 : 8, background: "#1a1a2eee", border: `1.5px solid ${t.color}${t.big ? "66" : "44"}`, boxShadow: `0 4px 16px #00000066,0 0 ${t.big ? 16 : 8}px ${t.color}${t.big ? "44" : "22"}`, animation: `${t.neg ? "slideInLeft" : "slideInRight"} .3s ease-out` }, className: t.neg ? "toast-enter-neg" : "toast-enter" }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 22 : 16, flexShrink: 0 } }, t.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 14 : 12, color: t.color, fontWeight: t.big ? 700 : 600, lineHeight: 1.3 } }, t.text)))), autoPlay && ph === "playing" && (() => {
    ...
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, n.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: n.color, fontWeight: 700 } }, n.text))), /* @__PURE__ */ React.createElement("button", { onClick: () => setDenNews([]), style: { background: "none", border: "none", color: "#666", fontSize: 10, cursor: "pointer", padding: "2px 4px" } }, "\u2715")), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 700, padding: "0 16px", zIndex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { height: 3, background: "#1a1a2e", borderRadius: 2, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { height: "100%", width: `${Math.min(100, rScore / tgt * 100)}%`, background: isNL ? "linear-gradient(90deg,#b85c2c,#f59e0b,#fef08a,#ffffffcc)" : "linear-gradient(90deg,#fbbf24,#4ade80)", borderRadius: 2, transition: "width .5s cubic-bezier(.34,1.56,.64,1)" } }))), ph === "scoring" && sRes && /* @__PURE__ */ React.createElement("div", { onClick: scoringDone ? advanceFromScoring : skipScoring, style: {
      cursor: "pointer",
      position: "fixed",
      inset: 0,
      background: "#000000cc",
      ...
      return /* @__PURE__ */ React.createElement("div", { style: {
        ...
        } }, displayPrimary, displayCombo ? /* @__PURE__ */ React.createElement("span", { style: { color: "#c084fc" } }, " + ", displayCombo) : ""), htLvMatch && !done && /* @__PURE__ */ React.createElement("span", { style: { fontSize: isReveal ? 13 : 11, fontWeight: 700, color: "#fbbf24", background: "#fbbf2418", padding: isReveal ? "3px 9px" : "2px 7px", borderRadius: 6, letterSpacing: 1, border: "1px solid #fbbf2433", animation: isReveal ? "fadeIn .8s ease-out" : "none" } }, "LV", htLvMatch[1])), !isReveal && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: done ? 2 : 4 } }), anyDisc && done && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc", fontWeight: 700, letterSpacing: 2, animation: "fadeIn .5s ease-out", marginBottom: 4 } }, "\u2728 SECRET COMBO DISCOVERED \u2728"), done && !anyDisc && (() => {
          const eo = htObj?.echo;
        ...
        return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", animation: isFirstStep ? "fadeIn .4s ease-out" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", transition: "transform .2s", transform: (isChipStep || isFirstStep) && !done ? "scale(1.2)" : "scale(1)" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6", fontWeight: 900, fontSize: done ? 26 : 22, transition: "font-size .2s", textShadow: (isChipStep || isFirstStep) && !done ? "0 0 12px #3b82f644" : "none", animation: isFirstStep ? "countUp .4s ease-out" : "none" } }, displayChips), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#3b82f688", letterSpacing: 2 } }, "CHIPS")), /* @__PURE__ */ React.createElement("span", { style: { color: "#ffffff55", fontSize: 16 } }, "\xD7"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", transition: "transform .2s", transform: (isMultStep || isFirstStep) && !done ? "scale(1.2)" : "scale(1)" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444", fontWeight: 900, fontSize: done ? 26 : 22, transition: "font-size .2s", textShadow: (isMultStep || isFirstStep) && !done ? "0 0 12px #ef444444" : "none", animation: isFirstStep ? "countUp .4s ease-out" : "none" } }, displayMult), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444488", letterSpacing: 2 } }, "MULT")), /* @__PURE__ */ React.createElement("span", { style: { color: "#ffffff55", fontSize: 16 } }, "="), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement(AnimatedScore, { value: displayTotal, style: {
          fontWeight: 900,
          fontSize: done ? 38 : 28,
          color: counterColor,
      ...
      return allT.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#666", textAlign: "center", padding: "8px 0", lineHeight: 1.5 } }, "No trait yet. Cats can earn traits through den events, breeding, or the shop.") : allT.map((t, ti) => {
      ...
      if (blind === 2 && bossTraits.some((bt) => bt.fx.noStrength)) {
        return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#fbbf24", letterSpacing: 2 } }, preview.type.name), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ef4444bb", fontStyle: "italic" } }, "\u{1F441}\uFE0F Watchful. it sees your hand"));
      }
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 700, color: "#fbbf24", letterSpacing: 2 } }, preview.type.name), preview.combo && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: "#c084fc", letterSpacing: 1 } }, "+ ", (meta?.stats?.dh || []).includes(preview.combo.name) ? preview.combo.name : "????"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#888" } }, baseC, "\xD7", baseM), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 900, color: tier.c, letterSpacing: 1, textShadow: `0 0 8px ${tier.c}44` } }, tier.w)), (() => {
        ...
        return line ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff22", fontStyle: "italic", animation: "fadeIn .5s ease-out" } }, line) : null;
      ...
      })), benchTraited.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, alignItems: "center", padding: "2px 6px", borderRadius: 4, background: "#ffffff06", border: "1px solid #ffffff0a" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#888" } }, "\u{1FA91}"), benchTraited.slice(0, 3).map((c) => /* @__PURE__ */ React.createElement("span", { key: c.id, style: { fontSize: 10 }, title: `${c.name.split(" ")[0]}: bench bonus` }, (c.trait || {}).icon || "\xB7"))), benchCats.length > 0 && (() => {
    ...
    })(), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, padding: "8px", zIndex: 10, alignItems: "center", position: mob ? "sticky" : "static", bottom: mob ? 0 : "auto", background: mob ? "#0a0a1aee" : "transparent", borderTop: mob ? "1px solid #ffffff0a" : "none", justifyContent: "center" } }, ph === "playing" && hLeft <= 0 && rScore < tgt ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => endRun(false, rScore), style: { ...BTN("linear-gradient(135deg,#ef4444,#dc2626)", "#fff"), padding: mob ? "12px 24px" : "10px 20px", fontSize: 14, animation: "fpp 1.5s ease infinite" } }, "Colony Fell"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444bb", marginTop: 4 } }, "No hands remaining")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, runCount >= 1 ? (() => {
      const cost = recruitCost();
