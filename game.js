...
function CC({ cat: _cat, sel, onClick, sm, cw: _cw, dis, hl, fog, chemHint, denMode, onTraitClick }) {
  ...
  let rankLabel = null;
  if (fog) return /* @__PURE__ */ React.createElement("div", { onClick: dis ? void 0 : onClick, style: { width: w, height: h, borderRadius: sm ? 8 : 12, background: "#0d1117", border: "2px solid #ffffff12", boxShadow: "0 2px 8px #00000066", cursor: dis ? "default" : "pointer", transition: "all .15s", transform: sel ? "translateY(-12px) scale(1.05)" : "", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontFamily: "'Cinzel',serif" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: sm ? 22 : 30, opacity: 0.12, color: neon } }, "?"));
...
function FM({ level, prev }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 700, padding: "0 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { title: "NERVE multiplies ALL scores.\nGain: +1 per Dusk/Midnight clear.\nBoss: +hands remaining (faster clear = more nerve).\nNo decay. No loss.\nAt NINTH LIFE (max): \xD72.2 to ALL scores.", style: { fontSize: 12, fontWeight: 700, color: fv.color, letterSpacing: 2, textShadow: mx ? `0 0 14px ${fv.glow}` : level > 5 ? `0 0 6px ${fv.color}44` : "none", animation: mx ? "fp 1s ease-in-out infinite" : up ? "fpp .4s ease-out" : dn ? "shake .3s ease" : "none", fontFamily: "'Cinzel',serif", cursor: "help" } }, mx ? "\u2726 " : "", fv.name, mx ? " \u2726" : ""), /* @__PURE__ */ React.createElement("span", { style: { fontSize: fv.xM > 1 ? 13 : 11, color: fv.color, fontFamily: "system-ui", fontWeight: 900, opacity: fv.xM > 1 ? 1 : 0.3, letterSpacing: fv.xM > 1 ? 1 : 0, textShadow: fv.xM > 1.3 ? `0 0 8px ${fv.color}44` : "none" } }, fv.xM > 1 ? `\xD7${fv.xM}` : "\xD71"), ch && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 700, animation: "countUp .4s ease-out", color: up ? "#4ade80" : "#ef4444" } }, up ? "\u25B2" : "\u25BC")), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#555", fontFamily: "system-ui" } }, level, "/", NERVE_MAX)), /* @__PURE__ */ React.createElement("div", { style: { height: 8, background: "#1a1a2e", borderRadius: 4, overflow: "hidden", border: "1px solid #ffffff08" } }, /* @__PURE__ */ React.createElement("div", { style: { height: "100%", width: `${pct}%`, borderRadius: 4, background: mx ? "linear-gradient(90deg,#b85c2c,#f59e0b,#fef08a,#ffffffcc)" : `linear-gradient(90deg,#b8956a,${fv.color})`, transition: "width .5s cubic-bezier(.4,0,.2,1)", boxShadow: level > 5 ? `0 0 8px ${fv.color}44` : "none" } })), level === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui", marginTop: 2, textAlign: "center" } }, "Clear blinds to build Nerve. Faster boss clears give more."));
}
function ChemPreview({ cats }) {
  if (cats.length < 2) return null;
  const grudges = getGrudges(cats);
  if (!grudges.length) return null;
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", fontSize: 10, fontFamily: "system-ui" } }, grudges.map(([a, b], i) => /* @__PURE__ */ React.createElement("span", { key: `g${i}`, style: { color: "#fb923c" } }, "\u26A1", a.name.split(" ")[0], "+", b.name.split(" ")[0])));
}
function NinthLife() {
  ...
  function buildOutcomeText(evt, choice, targets, fx) {
    ...
    if (fx.targetTrait && targets[0]) lines.push({ text: `${targets[0].name.split(" ")[0]} learned something from the wall.`, color: "#c084fc", icon: "\u{1F4DC}" });
  ...
  if (ph === "coldOpen") {
    ...
    }), introStep >= coldLines.length - 1 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ffffff66", fontFamily: "system-ui", letterSpacing: 3, marginTop: 24, animation: "fadeIn 2s ease-out 1s both" } }, "tap to continue")));
  }
  if (ph === "firstIntro") {
    const pages = [
      // Page 0: Your role — exciting, not clinical
      () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, animation: "fadeIn .6s ease-out", opacity: 0.8 } }, "\u{1F525}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 900, color: "#fbbf24", letterSpacing: 5, fontFamily: "'Cinzel',serif", animation: "fadeIn .8s ease-out" } }, "THE LAST HEARTH"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ffffffaa", fontFamily: "system-ui", textAlign: "center", maxWidth: 340, lineHeight: 2, animation: "fadeIn 1.2s ease-out" } }, "A fire still burns. Cats are gathering.", /* @__PURE__ */ React.createElement("br", null), "Strays, fighters, survivors. They need someone to lead them."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#e8e6e3cc", fontFamily: "system-ui", textAlign: "center", maxWidth: 300, lineHeight: 1.8, animation: "fadeIn 1.6s ease-out", marginTop: 8 } }, "That's you. Keep the fire burning.", /* @__PURE__ */ React.createElement("br", null), "Survive the dark. Make them remember you.")),
      ...
      () => {
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", letterSpacing: 6, fontFamily: "system-ui", animation: "fadeIn .4s ease-out" } }, "READING A CARD"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, alignItems: "center", justifyContent: "center", animation: "fadeIn .6s ease-out", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement(CC, { cat: sampleCat }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 10, left: "100%", marginLeft: 6, display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 1, background: "#ffffff44" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#ffffffbb", fontFamily: "system-ui", whiteSpace: "nowrap" } }, "Power \u2192 chips")), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 28, right: "100%", marginRight: 6, display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#38bdf8", fontFamily: "system-ui", whiteSpace: "nowrap" } }, "Trait"), /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 1, background: "#ffffff44" } })), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 28, left: "100%", marginLeft: 6, display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 1, background: "#ffffff44" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: BREEDS.Autumn.color, fontFamily: "system-ui", whiteSpace: "nowrap" } }, "Season")), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", bottom: 6, right: "100%", marginRight: 6, display: "flex", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#e8e6e3aa", fontFamily: "system-ui", whiteSpace: "nowrap" } }, "Name \u2642\u2640"), /* @__PURE__ */ React.createElement("div", { style: { width: 20, height: 1, background: "#ffffff44" } })))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#4ade80bb", fontFamily: "system-ui", textAlign: "center", maxWidth: 320, lineHeight: 1.7, animation: "fadeIn .8s ease-out", fontWeight: 600 } }, "Same-season cats score better together.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "#ffffff55", fontSize: 11, fontWeight: 400 } }, "Higher power = more chips. Traits add multipliers.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "center", animation: "fadeIn 1s ease-out", marginTop: 4 } }, ["Autumn", "Winter", "Spring", "Summer"].map((s) => {
          const b = BREEDS[s];
      ...
      () => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, animation: "fadeIn .6s ease-out", opacity: 0.7 } }, "\u2694"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 700, color: "#fbbf24", letterSpacing: 4, fontFamily: "'Cinzel',serif", animation: "fadeIn .8s ease-out" } }, "THE BLOODLINES"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ffffffaa", fontFamily: "system-ui", textAlign: "center", maxWidth: 320, lineHeight: 1.9, animation: "fadeIn 1s ease-out" } }, "Three cats still carry the old blood.", /* @__PURE__ */ React.createElement("br", null), "Trained. Named. ", /* @__PURE__ */ React.createElement("b", { style: { color: "#fbbf24" } }, "Born with gifts the strays don't have.")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff88", fontFamily: "system-ui", textAlign: "center", maxWidth: 300, lineHeight: 1.7, animation: "fadeIn 1.2s ease-out", marginTop: 8 } }, "Choose them. The rest of the colony will follow."))
    ];
    ...
    } }, pages[introStep](), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginTop: 8 } }, pages.map((_, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { width: 8, height: 8, borderRadius: "50%", background: i === introStep ? "#fbbf24" : i < introStep ? "#fbbf2444" : "#333", transition: "all .3s" } }))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff66", fontFamily: "system-ui", animation: "fadeIn 2s ease-out", letterSpacing: 2 } }, isLast ? "Tap to start drafting" : "Tap to continue")));
  }
  if (ph === "naming" && namingCat) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 12, padding: 20, maxWidth: 420 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", letterSpacing: 6, fontFamily: "system-ui", animation: "fadeIn .6s ease-out" } }, "NAME YOUR CAT"), /* @__PURE__ */ React.createElement("div", { style: { animation: "float 3s ease-in-out infinite" } }, /* @__PURE__ */ React.createElement(CC, { cat: namingCat })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, alignItems: "center", animation: "fadeIn .8s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: b.color, fontWeight: 700, letterSpacing: 1 } }, b.icon, " ", b.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff66" } }, "Power ", namingCat.power)), tr.name !== "Plain" ? /* @__PURE__ */ React.createElement("div", { style: { padding: "12px 16px", borderRadius: 10, background: `${tierCol}08`, border: `1px solid ${tierCol}22`, maxWidth: 340, width: "100%", animation: "fadeIn 1s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", marginBottom: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18 } }, tr.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, color: tierCol, fontWeight: 700 } }, tr.name), tierLabel && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: tierCol, opacity: 0.6, letterSpacing: 1, textTransform: "uppercase" } }, tierLabel)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff77", fontFamily: "system-ui", lineHeight: 1.7 } }, detail)) : /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 16px", borderRadius: 10, background: "#ffffff06", border: "1px solid #ffffff11", maxWidth: 340, width: "100%", animation: "fadeIn 1s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ffffff77", fontFamily: "system-ui", lineHeight: 1.7 } }, "No special trait yet. This cat can earn one through events, breeding, or the shop.")), /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "nameInput",
        type: "text",
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff44", fontFamily: "system-ui", letterSpacing: 2 } }, "TAP TO RENAME"), /* @__PURE__ */ React.createElement("button", { id: "nameConfirm", onClick: () => {
  ...
  if (ph === "hearthFlash" && hearthFlash) {
    ...
    }, style: { cursor: "pointer", textAlign: "center", maxWidth: 90, animation: `float ${2.5 + i * 0.3}s ease-in-out ${i * 0.2}s infinite` } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontFamily: "system-ui", color: BREEDS[c.breed].color, marginTop: 3, fontWeight: 700 } }, c.name.split(" ")[0], c.epithet ? " " + c.epithet : ""), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff88", fontFamily: "system-ui" } }, (c.trait || PLAIN).icon, " ", (c.trait || PLAIN).name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui" } }, "P", c.power, c.scarred ? " \u2694" : "")))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setHearthFlash(null);
      setPh("draft");
      if (meta.stats.r === 1) {
  ...
  if (ph === "draft") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 14, padding: 20, maxWidth: 500 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 4, fontFamily: "system-ui", animation: "fadeIn .5s ease-out" } }, hasHearthLineage ? "DESCENDANTS OF THE HEARTH" : "THE GATHERING"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, [0, 1, 2].map((i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
      width: 10,
      height: 10,
      borderRadius: "50%",
    ...
    } })), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui", marginLeft: 4 } }, draftPicked.length + 1, " of 3")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#d9770699", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.7, maxWidth: 320, animation: `fadeIn ${isFirstRun2 ? "1s" : "0.4s"} ease-out` } }, storyText), !isFirstRun2 && draftPicked.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#fb923c", fontFamily: "system-ui", textAlign: "center", maxWidth: 300, lineHeight: 1.6, animation: "fadeIn 0.5s ease-out 0.2s both", padding: "6px 12px", borderRadius: 6, background: "#fb923c0d", border: "1px solid #fb923c22", fontWeight: 700 } }, "\u2696\uFE0F Strong cats attract weak strays. Choose wisely."), isFirstRun2 && draftPicked.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", fontFamily: "system-ui", textAlign: "center", maxWidth: 280, lineHeight: 1.5, animation: "fadeIn 1s ease-out .3s both" } }, "Pick who catches your eye."), draftPicked.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#4ade80bb", letterSpacing: 2 } }, "CHOSEN"), draftPicked.map((c, i) => /* @__PURE__ */ React.createElement(CC, { key: i, cat: c, sm: true, hl: true }))), !isFirstRun2 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", letterSpacing: 1, marginTop: 4 } }, "Choose one. The others scatter into the dark."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, justifyContent: "center", animation: `fadeIn .4s ease-out ${isFirstRun2 ? "0.8s" : "0.3s"} both` } }, draftPool.map((c, i) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontFamily: "system-ui", color: b.color, marginTop: 4, lineHeight: 1.3, fontWeight: 700 } }, c.name.split(" ")[0], " ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 400, opacity: 0.6, fontSize: 10 } }, c.sex === "M" ? "\u2642" : "\u2640")),
        /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff99", fontStyle: "italic", fontFamily: "system-ui", lineHeight: 1.4, minHeight: 28, marginTop: 3 } }, '"', voice, '"'),
        c.trait.name !== "Plain" && (() => {
          ...
          return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: tierColor(c.trait), fontFamily: "system-ui", marginTop: 2, lineHeight: 1.3, maxWidth: 120 } }, isFirstRun2 ? hook[c.trait.name] || c.trait.desc : c.trait.desc);
        })(),
        c.stats?.par && /* @__PURE__ */ React.createElement("div", { style: { color: "#c084fc", fontSize: 10, fontFamily: "system-ui", fontStyle: "italic", lineHeight: 1.3, marginTop: 1 } }, meta?.cats?.find((h) => c.parentIds?.includes(h.name)) ? `${c.stats.par.split("\xD7")[0]?.trim()}'s blood. The Hearth remembers.` : `Child of ${c.stats.par}`)
      );
    })), !isFirstRun2 && draftRejects.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", fontFamily: "system-ui", fontStyle: "italic" } }, "The ones you turned away haven't gone far...")));
  }
  if (ph === "nightCard" && nightCard) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: {
      ...
      marginBottom: 2
    } }, blindNames[nightCard.blind].toUpperCase()), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 16, marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 1, background: `linear-gradient(90deg,transparent,${glowColor}33)` } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ffffff55", letterSpacing: 8, fontFamily: "system-ui" } }, "NIGHT ", nightCard.ante), /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 1, background: `linear-gradient(90deg,${glowColor}33,transparent)` } })), isBoss2 && boss && /* @__PURE__ */ React.createElement("div", { style: {
      display: "flex",
    ...
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 48 } }, boss.icon), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 20, color: "#ef4444", fontWeight: 700, letterSpacing: 3, fontFamily: "'Cinzel',serif" } }, boss.name), /* @__PURE__ */ React.createElement("div", { style: { width: 80, height: 1, background: "linear-gradient(90deg,transparent,#ef444433,transparent)", margin: "4px 0" } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef444466", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.5 } }, boss.lore), boss.tauntFn && (() => {
      ...
      return taunt ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.6, marginTop: 4 } }, '"', taunt, '"') : null;
    })()), !isBoss2 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ffffff77", fontStyle: "italic", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 1s ease-out", textAlign: "center", textShadow: "0 0 20px #ffffff11", maxWidth: 320, marginBottom: 8 } }, whisper), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, color: "#ffffff44", fontStyle: "italic", fontFamily: "'Cinzel',serif", textAlign: "center", maxWidth: 320, lineHeight: 1.8, animation: "fadeIn 1.2s ease-out", letterSpacing: 1 } }, epi), NIGHT_SUB[Math.min(nightCard.ante - 1, 4)] && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ffffff66", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 280, lineHeight: 1.5, animation: "fadeIn 1.5s ease-out", marginTop: 4 } }, NIGHT_SUB[Math.min(nightCard.ante - 1, 4)])), nightCard.blind === 0 && nightCard.ante > 1 && (() => {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, showWhisper && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2433", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 2s ease-out .5s both", marginTop: 8 } }, wLine), narLine && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#c084fc55", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 320, lineHeight: 1.6, animation: "fadeIn 2.5s ease-out 1s both", marginTop: showWhisper ? 4 : 8, padding: "6px 12px", borderRadius: 8, background: "#c084fc06", border: "1px solid #c084fc11" } }, narLine));
    })(), isNinthDawn && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", letterSpacing: 5, fontFamily: "system-ui", animation: "fadeIn 1.8s ease-out", marginTop: 8 } }, "THE NINTH DAWN"), nightCard.ante >= MX && nightCard.blind === 0 && (fallen.length > 0 || allC.length > 0) && /* @__PURE__ */ React.createElement("div", { style: {
      ...
      } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 24px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: `${glowColor}66`, letterSpacing: 3, fontFamily: "system-ui", marginBottom: 4 } }, "TARGET"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: glowColor, textShadow: `0 0 20px ${glowColor}33` } }, ncTgt.toLocaleString())), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: "#ffffff08" } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#3b82f666", letterSpacing: 3, fontFamily: "system-ui", marginBottom: 4 } }, "HANDS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: "#3b82f6" } }, hLeft)), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: "#ffffff08" } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444466", letterSpacing: 3, fontFamily: "system-ui", marginBottom: 4 } }, "DISCARDS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isFirstEver ? 34 : 28, fontWeight: 900, color: "#ef4444" } }, ncDiscs)));
    })(), isFirstEver && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#4ade80bb", fontFamily: "system-ui", animation: "fadeIn 2s ease-out .8s both", marginTop: 12 } }, "Tap cats ", "\u2192", " Play Hand ", "\u2192", " Beat ", ncTgt.toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui", marginTop: 20, animation: `fadeIn 2s ease-out ${isFirstEver ? 1.2 : 0.6}s both` } }, "tap to begin")));
  }
  if (ph === "colonyFormed" && colonyData) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W, onClick: enterNight }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 14, padding: 20, maxWidth: 600 } }, isNinthDawn && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf24", letterSpacing: 6, fontFamily: "system-ui", animation: "float 3s ease-in-out infinite", marginBottom: -4 } }, "\u300C THE NINTH DAWN \u300D"), !isFirstRun2 && /* @__PURE__ */ React.createElement("div", { onClick: (e) => e.stopPropagation(), style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4, animation: "fadeIn 1s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24", letterSpacing: 4, fontFamily: "'Cinzel',serif", fontWeight: 700 } }, "NAME YOUR COLONY"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: colonyName,
    ...
    )), isFirstRun2 ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#77777799", letterSpacing: 6, fontFamily: "system-ui", animation: "fadeIn 1.5s ease-out" } }, "YOUR COLONY"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 16, justifyContent: "center", marginTop: 8 } }, chosen.map((c, i) => {
      const b = BREEDS[c.breed];
      return /* @__PURE__ */ React.createElement("div", { key: c.id, style: { textAlign: "center", animation: `fadeIn .6s ease-out ${0.3 + i * 0.4}s both` } }, /* @__PURE__ */ React.createElement(CC, { cat: c, hl: true }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: b.color, fontFamily: "system-ui", marginTop: 4, fontWeight: 700 } }, c.name.split(" ")[0]), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff77", fontStyle: "italic", fontFamily: "system-ui", lineHeight: 1.4, marginTop: 2, maxWidth: 100 } }, '"', cpk(flavorCache, `colVoice_${c.id}`, [c], () => getDraftVoice(c)), '"'));
    })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#888", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.6, maxWidth: 340, marginTop: 8, animation: "fadeIn .8s ease-out .5s both" } }, "Three you chose. Fifteen who were already here, waiting for someone worth following.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "#77777799" } }, "Eighteen against the dark. It only takes one night to find out if that's enough."))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#77777799", letterSpacing: 6, fontFamily: "system-ui", animation: "epicReveal 1.2s ease-out forwards" } }, "SURVIVE ", MX, " NIGHTS"), meta && meta.stats.r > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#777777bb", fontFamily: "system-ui", letterSpacing: 3 } }, (() => {
    ...
    })()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#888", letterSpacing: 4, fontFamily: "system-ui", animation: "fadeIn .6s ease-out .2s both" } }, "THE COLONY"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#d97706bb", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.6, maxWidth: 360, animation: "fadeIn .8s ease-out .15s both" } }, colonyThesis), bloodMemMsg && /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 16px", borderRadius: 8, background: "linear-gradient(135deg,#7a665208,#ef444408)", border: "1px solid #c084fc22", animation: "fadeIn 1s ease-out .3s both", textAlign: "center", maxWidth: 380 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc", fontFamily: "system-ui", fontStyle: "italic", lineHeight: 1.6 } }, "\u{1FA78} ", /* @__PURE__ */ React.createElement("b", null, bloodMemMsg.heir.split(" ")[0]), " carries something old. ", bloodMemMsg.trait.icon, " ", /* @__PURE__ */ React.createElement("span", { style: { color: "#e8e6e3" } }, bloodMemMsg.trait.name), ". inherited from ", /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24" } }, bloodMemMsg.ancestor), " of the Hearth.", bloodMemMsg.scarred && /* @__PURE__ */ React.createElement("span", { style: { color: "#d97706" } }, " The scar came with it."))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 20, justifyContent: "center", animation: "fadeIn 1s ease-out .25s both" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, fontWeight: 900, color: "#fbbf24", letterSpacing: 2, animation: "comboBurst .6s ease-out .35s both" } }, 14), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", letterSpacing: 2, fontFamily: "system-ui" } }, "SOULS")), /* @__PURE__ */ React.createElement("div", { style: { width: 1, height: 40, background: "#ffffff0a" } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, fontWeight: 900, color: "#ef4444", letterSpacing: 2, animation: "comboBurst .6s ease-out .45s both" } }, MX), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", letterSpacing: 2, fontFamily: "system-ui" } }, "NIGHTS"))), strayOffset && strayOffset !== 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: strayOffset > 0 ? "#4ade80aa" : "#fb923caa", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", animation: "fadeIn 1s ease-out .6s both", maxWidth: 340, lineHeight: 1.5 } }, strayOffset >= 2 ? "Weak cats attract strong strays. They had to be. your chosen carry less." : strayOffset === 1 ? "Weak cats attract strong strays. Something to prove." : strayOffset === -1 ? "Strong cats attract weak strays. They followed the light, not the fight." : "Strong cats attract weak strays. Your chosen burn bright. the rest just watched."), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", marginTop: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80", letterSpacing: 2, marginBottom: 6, textAlign: "center" } }, "CHOSEN. YOUR EDGE"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, justifyContent: "center", animation: "fadeIn .6s ease-out .6s both" } }, chosen.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, style: { textAlign: "center", cursor: "pointer" }, onClick: () => setTraitTip(c) }, /* @__PURE__ */ React.createElement(CC, { cat: c, hl: true }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: BREEDS[c.breed]?.color, fontFamily: "system-ui", marginTop: 2, fontWeight: 700 } }, c.name.split(" ")[0]), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui" } }, c.trait.name !== "Plain" ? c.trait.icon + " " + c.trait.name : "plain"))))), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 2, marginBottom: 6, textAlign: "center" } }, "THE ONES WHO WERE ALREADY HERE"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "center", animation: "fadeIn 1s ease-out .9s both" } }, BK.map((b) => {
    ...
    }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 3, padding: "4px 10px", borderRadius: 6, background: "#ffffff04", border: "1px solid #ffffff0a" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui" } }, "15 strays \xB7 all Plain"))))), hearthDust > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", borderRadius: 8, background: "#c084fc0a", border: "1px solid #c084fc22", animation: "fadeIn 1.5s ease-out 1.4s both" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, "\u{1F3E0}"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#c084fc", fontFamily: "system-ui" } }, "The Hearth radiates ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700 } }, "+", hearthDust, "\u2726"))), /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
      e.stopPropagation();
      enterNight();
    }, style: { background: "linear-gradient(135deg,#fbbf24,#f59e0b)", color: "#0a0a1a", border: "none", borderRadius: 10, padding: "14px 44px", fontSize: 17, fontWeight: 900, cursor: "pointer", letterSpacing: 4, fontFamily: "'Cinzel',serif", marginTop: 8, boxShadow: "0 0 40px #fbbf2433", textTransform: "uppercase", zIndex: 2 } }, "Enter the Night"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui", marginTop: 4 } }, "tap anywhere to continue")));
  }
  if (ph === "title") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement(Dust, null), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 10, right: 10, zIndex: 200, display: "flex", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui", letterSpacing: 1 } }, "v0.65"), meta && meta.stats.r >= 1 && /* @__PURE__ */ React.createElement("button", { onClick: async () => {
      const sums = [];
      for (let i = 1; i <= SLOT_COUNT; i++) sums.push(await getSlotSummary(i));
      setSlotSummaries(sums);
      setShowSlots(!showSlots);
    }, style: { background: "none", border: "1px solid #ffffff15", borderRadius: 6, fontSize: 10, cursor: "pointer", opacity: 0.5, padding: "3px 8px", color: "#888", fontFamily: "system-ui" }, title: "Save Slots" }, "\u{1F4BE} ", activeSlot), /* @__PURE__ */ React.createElement("button", { onClick: toggleMute, style: { background: "none", border: "none", fontSize: 16, cursor: "pointer", opacity: 0.4, padding: 4 }, title: muted ? "Unmute" : "Mute" }, muted ? "\u{1F507}" : "\u{1F50A}")), showSlots && slotSummaries && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 40, right: 10, zIndex: 300, background: "#0d1117ee", border: "1px solid #ffffff15", borderRadius: 12, padding: 14, width: 220, animation: "fadeIn .2s ease-out", fontFamily: "system-ui" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 2, marginBottom: 8 } }, "SAVE SLOTS"), slotSummaries.map((s, i) => {
      const n = i + 1;
      ...
      opacity: 0.3
    } }))), meta && meta.cats.length >= 1 && meta.cats.length <= 4 && meta.stats.w <= 2 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2455", fontFamily: "system-ui", fontStyle: "italic", letterSpacing: 2, animation: "fadeIn 3s ease-out" } }, meta.cats.length === 1 ? `${meta.cats[0].name.split(" ")[0]} watches from the warm side.` : meta.cats.length === 2 ? `${meta.cats[0].name.split(" ")[0]} and ${meta.cats[1].name.split(" ")[0]}. The Founders.` : `The Hearth burns. ${meta.cats.slice(0, 3).map((c) => c.name.split(" ")[0]).join(", ")} watch.`), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: "clamp(32px,7vw,52px)", fontWeight: 900, letterSpacing: 6, lineHeight: 1.1, background: (meta?.achv || []).includes("completionist") ? "linear-gradient(135deg,#c084fc,#fef08a,#4ade80,#67e8f9)" : "linear-gradient(135deg,#b85c2c,#fbbf24,#fef08a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", margin: 0 } }, "NINTH LIFE", meta?.ninthDawnCleared ? " \u{1F305}" : ""), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888888bb", letterSpacing: 3, fontFamily: "system-ui", lineHeight: 1.6, animation: "fadeIn 2.5s ease-out" } }, "Cats are cards. Seasons are suits. Survive the dark."), (() => {
      const ch = getChapterTitle(meta);
      return ch ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc66", letterSpacing: 4, fontFamily: "'Cinzel',serif", animation: "fadeIn 3s ease-out" } }, "Chapter ", ch.num, " \xB7 ", ch.name) : null;
    })(), meta && meta.stats.r >= 1 && (() => {
      const earned = (meta.achv || []).length;
      const total = ACHIEVEMENTS.length;
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 3, animation: "fadeIn 2s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", letterSpacing: 2, fontFamily: "system-ui" } }, "ACHIEVEMENTS ", earned, "/", total), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center", maxWidth: 200 } }, ACHIEVEMENTS.map((a) => {
    ...
    })(), hasRun && meta && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 2 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { color: "#c084fc", fontSize: 13, fontWeight: 700 } }, "\u2726 ", sd, " Stardust"), sd > 0 && !showUpgrades && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#c084fc66", fontFamily: "system-ui" } }, "earned from the Hearth"), sd > 0 && showUpgrades && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#c084fc66", fontFamily: "system-ui", cursor: "pointer" }, onClick: () => setTab("\u2726 upgrades") }, "spend on upgrades \u25B8"), meta.cats.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fcbb", fontFamily: "system-ui" } }, "\u{1F3E0} +", calcTotalHearthDust(meta.cats, getMB().dustBonus || 0, getHeatFx(meta?.heat).dustMult || 1).total, "/run")), showHeat && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ef4444", fontFamily: "system-ui" } }, "Heat ", meta.heat), meta.heat > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui" } }, "+", meta.heat * 25, "% hearth")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, alignItems: "center" } }, Array.from({ length: (meta.stats.mh || meta.heat || 1) + 1 }).map((_, h) => {
    ...
    })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444466", fontFamily: "system-ui" } }, meta.heat === 0 ? "Standard difficulty." : "Tap a number to change."))), availTabs.length > 1 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, background: "#ffffff08", borderRadius: 8, padding: 2 } }, availTabs.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, onClick: () => setTab(t), style: { padding: "5px 14px", fontSize: 10, border: "none", borderRadius: 6, cursor: "pointer", background: safeTab === t ? "#ffffff12" : "transparent", color: safeTab === t ? "#e8e6e3" : "#666", fontFamily: "'Cinzel',serif", letterSpacing: 1, textTransform: "uppercase", fontWeight: safeTab === t ? 700 : 400 } }, t))), safeTab === "play" && /* @__PURE__ */ React.createElement(React.Fragment, null, false, savedRun && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      Audio.init();
      resumeRun(savedRun);
      ...
      Audio.init();
      startNinthDawn();
    }, style: { ...BTN("linear-gradient(135deg,#fbbf24,#fef08a)", "#0a0a1a"), padding: "10px 36px", fontSize: 13, letterSpacing: 4, textTransform: "uppercase", boxShadow: "0 0 20px #fbbf2444", animation: "float 3s ease-in-out infinite" } }, "\u300C THE NINTH DAWN \u300D"), meta?.ninthDawnCleared && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", fontFamily: "system-ui", fontStyle: "italic" } }, "\u{1F305} The dawn holds."), showLongDark && !isFirstRun && /* @__PURE__ */ React.createElement("button", { onClick: () => setLongDark((v) => !v), style: { padding: "6px 16px", fontSize: 10, border: `1px solid ${longDark ? "#818cf8" : "#ffffff22"}`, borderRadius: 6, cursor: "pointer", background: longDark ? "#818cf822" : "transparent", color: longDark ? "#818cf8" : "#666", fontFamily: "system-ui", letterSpacing: 1, marginTop: 2 } }, longDark ? "\u{1F311} THE LONG DARK \u2014 9 nights" : "\u{1F311} The Long Dark"), longDark && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#818cf8aa", fontStyle: "italic", fontFamily: "system-ui" } }, "Nine nights. Nine colonies. The full weight of the dark."), showHeat && (meta.heat || 0) > 0 && HEAT_FLAVOR[meta.heat] && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui" } }, HEAT_FLAVOR[meta.heat]), (meta?.relics || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center" } }, (meta.relics || []).sort().map((h) => {
      const r = HEAT_RELICS[h];
      return r ? /* @__PURE__ */ React.createElement("div", { key: h, style: { padding: "3px 8px", borderRadius: 5, background: "#fbbf2408", border: "1px solid #fbbf2422", fontSize: 10, color: "#fbbf24", fontFamily: "system-ui" }, title: `${r.name}: ${r.desc}
"${r.flavor}"` }, r.icon, " ", r.name) : null;
    })), (!meta || meta.stats.r === 0) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", fontFamily: "system-ui", lineHeight: 1.5, textAlign: "center", maxWidth: 300 } }, "3 nights. 18 cats. The game teaches as you play."), meta && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, fontFamily: "system-ui", fontSize: 10, color: "#555", alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setSeen((s) => ({ ...s, howToPlay: !s.howToPlay })), style: { background: "none", border: "1px solid #ffffff12", borderRadius: 12, color: "#555", fontSize: 10, cursor: "pointer", padding: "2px 8px", fontFamily: "system-ui" } }, "How to Play"), /* @__PURE__ */ React.createElement("span", null, meta.stats.r, " runs"), /* @__PURE__ */ React.createElement("span", null, meta.stats.w, " wins")), seen.howToPlay && /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 16px", borderRadius: 10, background: "#ffffff06", border: "1px solid #ffffff0a", maxWidth: 400, fontSize: 13, fontFamily: "system-ui", color: "#aaa", lineHeight: 1.6, animation: "fadeIn .4s ease-out", textAlign: "left" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, color: "#fbbf24", marginBottom: 4 } }, "Quick Rules"), "Draw 6 cats. Pick up to 5 \u2014 match 3+ of one season for Clowder or Colony. Discard to swap cards (free). Recruit to draw extra cats (costs \u{1F41F}). Unplayed cats give bench bonuses. Chips \xD7 Mult = score. Beat the target.", /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, "Scars (\xD71.25) and Bonds (\xD71.5) multiply your score. Nerve builds every blind you clear \u2014 fast boss clears give more. In the Den, shelter a \u2642+\u2640 pair to breed. Everyone else enters the wilds."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6, color: "#67e8f9" } }, "\u{1F3AF} Match seasons for Clowder or Colony hands. Stack traits for big multipliers. Unplayed cats in your hand give bench bonuses."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6, color: "#34d399" } }, "\u{1F46A} Shelter a parent with their child to teach traits. Save a M/F pair to the Hearth \u2014 their descendants begin your next colony.")), meta && (mb.gold > 0 || mb.hands > 0 || mb.discards > 0 || mb.fervor > 0) && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center", fontFamily: "system-ui", fontSize: 10 } }, mb.gold > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24" } }, "+", mb.gold, "\u{1F41F}"), mb.hands > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6" } }, "+", mb.hands, "H"), mb.discards > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, "+", mb.discards, "D"), mb.fervor > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#d97706" } }, "N+", mb.fervor))), safeTab === "\u2726 upgrades" && meta && /* @__PURE__ */ React.createElement("div", { style: { width: "100%", display: "flex", flexDirection: "column", gap: 6 } }, (() => {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "8px 0" } }, (() => {
        ...
        return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: tier.color + "88", letterSpacing: 3, fontFamily: "system-ui", marginBottom: 4 } }, tier.icon, " ", tier.name, tier.bonus ? ` \xB7 ${tier.bonus}` : "");
      })(), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fcbb", letterSpacing: 3, fontFamily: "system-ui" } }, "STARDUST PER RUN"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 900, color: "#c084fc", textShadow: "0 0 20px #c084fc44" } }, "+", hd.total, "\u2726"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc66", fontFamily: "system-ui", lineHeight: 1.6 } }, (dustBonus > 0 || heatMult > 1 || hd.maintenance > 0) && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", null, "Gross ", hd.gross, "\u2726"), dustBonus > 0 && /* @__PURE__ */ React.createElement("span", null, " (\xD7", 1 + dustBonus, " bonus)"), heatMult > 1 && /* @__PURE__ */ React.createElement("span", null, " (\xD7", heatMult, " heat)"), hd.maintenance > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444bb" } }, " \u2212 ", hd.maintenance, "\u2726 upkeep (", hd.activeCats - 8, " above 8)"))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui" } }, "Each saved cat radiates stardust when you enter the night")), activeCats.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 2, fontFamily: "system-ui" } }, "HEARTH (", activeCats.length, " cats", hd.maintenance > 0 ? `. ${hd.maintenance}\u2726 upkeep` : "", ")"), (() => {
        ...
        return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2444", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.5, animation: "fadeIn 2s ease-out", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { color: BREEDS[whisperCat.breed]?.color || "#888", fontWeight: 600 } }, fn, ":"), " ", templates[Math.floor(Date.now() / 8e3) % templates.length]);
        ...
        } }, /* @__PURE__ */ React.createElement(CC, { cat: { ...c, id: `ht${i}`, trait: tr }, sm: true }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: "#c084fc", fontFamily: "system-ui", marginTop: 1, textShadow: "0 0 6px #c084fc44" } }, "+", perCat, "\u2726"), meta.cats.length >= 20 && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      }))), enshrinedCats.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf24bb", letterSpacing: 2, fontFamily: "system-ui", marginTop: 4 } }, "\u{1F31F} ENSHRINED (", enshrinedCats.length, "). eternal, no upkeep"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center" } }, enshrinedCats.map((c, i) => {
        const tr = TRAITS.find((t) => t.name === c.trait.name) || c.trait;
        return /* @__PURE__ */ React.createElement("div", { key: `en${i}`, style: { textAlign: "center", position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { border: "2px solid #fbbf2444", borderRadius: 8, padding: 1 } }, /* @__PURE__ */ React.createElement(CC, { cat: { ...c, id: `en${i}`, trait: tr }, sm: true })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2466", fontFamily: "system-ui" } }, "\u{1F31F}"));
      }))));
    })() : /* @__PURE__ */ React.createElement("div", { style: { color: "#555", fontSize: 11, fontFamily: "system-ui", textAlign: "center", padding: "20px 0" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28, opacity: 0.3, marginBottom: 8 } }, "\u{1F3E0}"), "No survivors yet. Win a run and save a cat to the Hearth.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "#c084fcbb", fontSize: 10 } }, "Each saved cat will generate \u2726 Stardust at the start of every run.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, justifyContent: "center" } }, BK.map((b) => {
    ...
    }), BK.every((b) => (meta.stats.disc || []).some((d) => d.startsWith(b))) && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui", fontWeight: 700 } }, "\u2713 All seasons!")), (meta.achv || []).length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 2, marginBottom: 3 } }, "ACHIEVEMENTS (", (meta.achv || []).length, "/", ACHIEVEMENTS.length, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center" } }, ACHIEVEMENTS.filter((a) => (meta.achv || []).includes(a.id)).map((a) => /* @__PURE__ */ React.createElement("span", { key: a.id, onClick: () => toast(a.icon, `${a.name}: ${a.reward}`, "#fbbf24"), style: { fontSize: 10, padding: "3px 8px", borderRadius: 5, background: "#fbbf2411", border: "1px solid #fbbf2422", color: "#fbbf24", fontFamily: "system-ui", cursor: "pointer" }, title: `${a.desc} \u2192 ${a.reward}` }, a.icon, " ", a.name)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center", opacity: 0.4 } }, ACHIEVEMENTS.filter((a) => !(meta.achv || []).includes(a.id)).map((a) => /* @__PURE__ */ React.createElement("span", { key: a.id, onClick: () => toast(a.icon, `${a.name}: ${a.desc}`, "#555"), style: { fontSize: 10, padding: "2px 6px", borderRadius: 4, background: "#ffffff04", border: "1px solid #ffffff08", color: "#555", fontFamily: "system-ui", cursor: "pointer" }, title: a.desc }, a.icon, " ", a.name))), meta.ninthDawnCleared && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, padding: "12px 16px", borderRadius: 10, background: "linear-gradient(135deg,#fbbf2408,#7a665208)", border: "1px solid #fbbf2422" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#fbbf24", letterSpacing: 4, textAlign: "center", fontWeight: 700 } }, "\u{1F305} THE RECORD"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2466", fontFamily: "system-ui", textAlign: "center", marginTop: 3, marginBottom: 8 } }, "Every cat who ever carried the colony's name."), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", maxWidth: 300, height: 300, margin: "0 auto", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, borderRadius: "50%", border: "1px solid #ffffff06" } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: "15%", borderRadius: "50%", border: "1px solid #ffffff04" } }), meta.cats.map((c, i) => {
...
Saved from Night ${c.fromAnte || "?"}`, style: {
    ...
    }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, opacity: 0.5 } }, "\u{1F525}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2466", fontFamily: "system-ui" } }, meta.cats.length, " saved"))), (() => {
  ...
  if (ph === "bossIntro") {
    ...
    } }), /* @__PURE__ */ React.createElement("div", { style: { display: "none", width: "100%", height: "100%", alignItems: "center", justifyContent: "center", fontSize: 72, background: "#0d1117" } }, b.icon)) : /* @__PURE__ */ React.createElement("div", { style: { fontSize: vw < 500 ? 48 : 72, filter: "drop-shadow(0 0 30px #ef444488)", animation: "fadeIn 1.2s ease-out" } }, b.icon), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 30, color: "#ef4444", letterSpacing: 8, margin: 0, textShadow: "0 0 40px #ef444488", animation: "tierReveal 1s ease-out", fontFamily: "'Cinzel',serif" } }, b.name), hasMastery && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24", letterSpacing: 4, fontFamily: "system-ui", fontWeight: 700, animation: "fadeIn 1.2s ease-out" } }, "YOU ARE THE ", mastery.title), (bWins > 0 || bLoss > 0) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444466", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 1.5s ease-out" } }, bWins, "W / ", bLoss, "L"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 17, color: "#ef4444", fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", opacity: 0.8, animation: "fadeIn 1.5s ease-out", lineHeight: 1.6, maxWidth: 360, textShadow: "0 0 20px #ef444422" } }, '"', b.taunt, '"'), careerTaunt && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ef4444aa", fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", animation: "fadeIn 2s ease-out", lineHeight: 1.5, maxWidth: 340 } }, '"', careerTaunt, '"'), dynamicTaunt && !careerTaunt && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ef4444bb", fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", animation: "fadeIn 2s ease-out" } }, '"', dynamicTaunt, '"'), bossTraits.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", justifyContent: "center", animation: "fadeIn 1.8s ease-out", maxWidth: 400 } }, bossTraits.map((t, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { padding: "8px 14px", borderRadius: 8, background: "#ef444415", border: "1px solid #ef444433", textAlign: "center", minWidth: 120, maxWidth: 180 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, t.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#ef4444", fontWeight: 700, letterSpacing: 1 } }, t.name)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ef4444cc", fontFamily: "system-ui", marginTop: 3, lineHeight: 1.3 } }, t.desc), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui", marginTop: 2 } }, t.flavor)))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 2.5s ease-out" } }, b.lore), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", justifyContent: "center", marginTop: 4 } }, curses.map((c, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { padding: "6px 10px", borderRadius: 8, background: "#ef444408", border: "1px solid #ef444433", textAlign: "center", minWidth: 90 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, c.icon), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444", fontWeight: 600, marginTop: 1 } }, c.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ef4444bb", fontFamily: "system-ui", marginTop: 1 } }, c.desc)))), cfx.exileBreed && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444bb", fontFamily: "system-ui" } }, BREEDS[cfx.exileBreed].icon, " ", cfx.exileBreed, " exiled"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#666", fontFamily: "system-ui", marginTop: 8 } }, "Threshold: ", /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444", fontWeight: 700, fontSize: 16 } }, eTgt().toLocaleString()), (meta?.heat || 0) > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444bb", fontSize: 10 } }, " (Heat +", (meta.heat || 0) * 10, "%)")), hasRelic(3) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade8066", fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 2.5s ease-out", padding: "4px 12px", borderRadius: 6, background: "#4ade8008", border: "1px solid #4ade8018" } }, "\u{1F441}\uFE0F The Vigil whispers: ", b.id === "hunger" ? "Bonds score double here. Fill every hand." : b.id === "territory" ? "Scars make you stronger. The Territory respects fighters." : b.id === "mother" ? "Don't spread thin. Pick your best five and commit." : b.id === "swarm" ? "Nerve is everything. Build it before you get here." : b.id === "forgetting" ? "Every name matters. Play your bonded pairs." : b.id === "fraying" ? "Resolve your grudges before you get here. Every grudge is \u22122 mult." : b.id === "eclipse" ? "Don't rest. Momentum carries through." : b.id === "ember" ? "Give everything. One more hand is all it takes." : "Trust the colony."), /* @__PURE__ */ React.createElement("button", { onClick: () => {
  ...
  if (ph === "event" && colEvent) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: "12%", left: "50%", transform: "translateX(-50%)", width: 350, height: 350, borderRadius: "50%", background: `radial-gradient(circle,${evtGlow}06,transparent 70%)`, pointerEvents: "none", zIndex: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 0, padding: 20, maxWidth: 480 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff12", letterSpacing: 8, fontFamily: "system-ui", marginBottom: 16, animation: "fadeIn 1.2s ease-out", textTransform: "uppercase" } }, "Night ", ante, " ", "\xB7", " ", ["Dusk", "Midnight", "After the Boss"][blind]), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 64, marginBottom: 8, animation: "fadeIn .6s ease-out", filter: `drop-shadow(0 0 40px ${evtGlow}22)` } }, evt.icon), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 20, color: "#e8e6e3", letterSpacing: 6, margin: "0 0 6px 0", fontWeight: 600, animation: "fadeIn .8s ease-out", fontFamily: "'Cinzel',serif" } }, evt.title), evt.tag && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: evtGlow + "66", fontFamily: "system-ui", letterSpacing: 4, padding: "3px 12px", borderRadius: 12, border: `1px solid ${evtGlow}15`, marginBottom: 16, animation: "fadeIn 1s ease-out", textTransform: "uppercase" } }, evt.tag), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "#c8c2bbdd", fontFamily: "system-ui", textAlign: "center", lineHeight: 2.1, maxWidth: 360, fontStyle: "italic", animation: "fadeIn 1.2s ease-out", marginBottom: 16, padding: "0 8px" } }, evtText), meta && meta.cats.length > 0 && tgts.length > 0 && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#c084fc44", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 300, lineHeight: 1.5, animation: "fadeIn 2s ease-out", marginBottom: 8 } }, cpk(flavorCache, "bossHearth", templates));
    })(), tgts.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, justifyContent: "center", marginBottom: 20, animation: "fadeIn 1s ease-out 0.3s both" } }, tgts.map((t, i) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4 } }, /* @__PURE__ */ React.createElement(CC, { cat: t }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: BREEDS[t.breed]?.color || "#888", fontFamily: "system-ui", letterSpacing: 1, fontWeight: 700 } }, t.name.split(" ")[0]), t.trait && t.trait.name !== "Plain" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff44", fontFamily: "system-ui" } }, t.trait.icon, " ", t.trait.name)))), /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 1, background: `linear-gradient(90deg,transparent,${evtGlow}22,transparent)`, marginBottom: 16 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, width: "100%", maxWidth: vw < 500 ? vw - 32 : 380 } }, evt.choices.map((ch, i) => {
      ...
      } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, color: canAfford ? "#e8e6e3" : "#555", fontWeight: 500, letterSpacing: 1, lineHeight: 1.4 } }, label), hint && canAfford && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: hint.c, fontFamily: "system-ui", letterSpacing: 1, flexShrink: 0, padding: "3px 8px", borderRadius: 6, background: hint.c + "11", border: `1px solid ${hint.c}22`, display: "flex", alignItems: "center", gap: 3 } }, hint.ic, " ", hint.t)), !canAfford && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ef4444bb", fontFamily: "system-ui", display: "block", marginTop: 4 } }, "Need ", Math.abs(ch.fx.gold || 0), "\u{1F41F}"));
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui" } }, allCount, " cats"), scarCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fb923c33", fontFamily: "system-ui" } }, scarCount, " scarred"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fbbf24", fontFamily: "system-ui", fontWeight: 700 } }, gold, "\u{1F41F}"));
    })())));
  }
  ...
  if (ph === "overflow" && oData) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { ...W, animation: clutch ? "flash .6s ease-out" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), clutch && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 50, background: "radial-gradient(circle,#fbbf2433,transparent 70%)", pointerEvents: "none", animation: "flash 1.5s ease-out" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 10, padding: 20 } }, clutch && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 900, color: "#fbbf24", letterSpacing: 8, textShadow: "0 0 30px #fbbf24cc", animation: "clutchBurst .8s ease-out", fontFamily: "'Cinzel',serif", marginBottom: 4 } }, "CLUTCH"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: blind >= 2 ? "#4ade80" : "#fbbf24", letterSpacing: 3 } }, blind >= 2 ? clutch ? "Survived. Barely." : "Survived." : "The threshold breaks."), clearLine && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ffffffbb", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 320, lineHeight: 1.6, animation: "fadeIn 1.2s ease-out", textShadow: "0 0 15px #ffffff11" } }, clearLine), blind >= 2 && boss && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "10px 16px", borderRadius: 10, background: "#4ade8008", border: "1px solid #4ade8022", maxWidth: 360, animation: "fadeIn 1.5s ease-out" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#4ade80", fontWeight: 700, fontFamily: "'Cinzel',serif", letterSpacing: 2, marginBottom: 4 } }, boss.name, " falls."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#4ade80cc", fontStyle: "italic", fontFamily: "system-ui", lineHeight: 1.6 } }, '"', boss.defeat, '"'), dLine && dLine !== boss.defeat && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#4ade80aa", fontStyle: "italic", fontFamily: "system-ui", marginTop: 4, lineHeight: 1.5 } }, '"', dLine, '"'));
    })(), blind === 1 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#ef4444", fontWeight: 700, letterSpacing: 3, fontFamily: "system-ui", animation: "fpp 1s ease infinite" } }, "Something approaches..."), ante >= 4 && blind < 2 && (clutch || o.fs < o.tgt * 1.3) && boss && (() => {
      ...
      return earlyTaunt ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", animation: "fadeIn 1.5s ease-out", padding: "6px 14px", borderRadius: 8, background: "#ef444408", border: "1px solid #ef444418", maxWidth: 340 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, boss.icon), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui", lineHeight: 1.5 } }, '"', earlyTaunt, '"'), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444433", fontFamily: "system-ui", marginTop: 2 } }, boss.name, " watches.")) : null;
    })(), (() => {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: scoreSize, fontWeight: 900, color: scoreColor, textShadow: `0 0 ${glowSize}px ${scoreColor}44`, animation: shakeAnim || "fadeIn .6s ease-out", letterSpacing: pctClear >= 200 ? 3 : 1 } }, o.fs.toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: tgtSize, color: pctClear >= 200 ? "#888" : "#666", fontFamily: "system-ui" } }, "Threshold: ", o.tgt.toLocaleString()));
    })(), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5, background: "#ffffff06", borderRadius: 12, padding: "14px 22px", border: "1px solid #ffffff0a", minWidth: 260 } }, /* @__PURE__ */ React.createElement("div", { onClick: () => toast("\u{1F4CA}", "The higher you score above the target, the more rations you earn. Survived: 2\u{1F41F}, Comfortable: 3\u{1F41F}, Crushing: 4\u{1F41F}, Dominating: 5-6\u{1F41F}, Legendary: 6\u{1F41F}. Boss rounds give +2\u{1F41F} extra.", "#fbbf24"), style: { display: "flex", justifyContent: "space-between", fontFamily: "system-ui", fontSize: 11, cursor: "help" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#888" } }, "Performance"), /* @__PURE__ */ React.createElement("span", { style: { color: pctClear >= 300 ? "#c084fc" : pctClear >= 200 ? "#fbbf24" : pctClear >= 150 ? "#4ade80" : "#888", fontWeight: 700 } }, pctClear >= 300 ? "Legendary" : pctClear >= 200 ? "Dominating" : pctClear >= 150 ? "Crushing" : pctClear >= 120 ? "Comfortable" : "Survived", " (", pctClear, "%)")), o.uh > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontFamily: "system-ui", fontSize: 11 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#888" } }, o.uh, " Unused Hand", o.uh > 1 ? "s" : ""), /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6" } }, "saved")), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid #ffffff0a", paddingTop: 4, display: "flex", justifyContent: "space-between", fontFamily: "system-ui", fontSize: 11 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#888" } }, "Rations Earned"), /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24", fontWeight: 700 } }, "+", o.gR, " \u{1F41F}")), o.interest > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontFamily: "system-ui", fontSize: 11 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80" } }, "Stores (interest)"), /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80", fontWeight: 700 } }, "+", o.interest, " \u{1F41F}"))), (() => {
      const overflowLines = [
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: seed < 3 && whisperPool ? "#fbbf2444" : "#ffffff44", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 280, lineHeight: 1.5, marginTop: 8, animation: "fadeIn 1.5s ease-out" } }, line);
    })(), blind >= 2 ? (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 8, marginTop: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80bb", letterSpacing: 2, fontFamily: "system-ui" } }, "CHOOSE YOUR REWARD"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center" } }, choices.map((rw, i) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: rw.id || i,
        ...
        /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", marginTop: 3, lineHeight: 1.3 } }, rw.desc)
      ))));
      ...
      gap: 2,
      minWidth: 100
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F3EA}"), /* @__PURE__ */ React.createElement("span", null, isFirstRun && !seen.shop ? "Enter the Market \u2726" : "Market"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6, fontFamily: "system-ui" } }, "buy wards, cats, scrolls")), (seen.shop || !isFirstRun) && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      const baseG = 3 + ante;
      const results = [];
      let bonusG = 0;
      ...
      gap: 2,
      minWidth: 100
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F33F}"), /* @__PURE__ */ React.createElement("span", null, "Scavenge"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6, fontFamily: "system-ui" } }, "+", 3 + ante, "\u{1F41F}, maybe more")), (seen.shop || !isFirstRun) && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setCampMode(true);
      setDen([]);
      setOData(null);
      setPh("denSelect");
      ...
      gap: 2,
      minWidth: 100
    } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, "\u{1F3D5}"), /* @__PURE__ */ React.createElement("span", null, "Camp"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 400, opacity: 0.6, fontFamily: "system-ui" } }, "heal, +1 nerve, watch pair"))))));
  }
  if (ph === "defeat" && defeatData) {
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 16, padding: 20, maxWidth: 500 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 64, opacity: 0.6, animation: "fadeIn 1s ease-out", filter: "drop-shadow(0 0 30px #ef444488)" } }, "\u{1F480}"), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 28, color: "#ef4444", letterSpacing: 6, margin: 0, textShadow: "0 0 40px #ef444444", animation: "tierReveal 1s ease-out", fontFamily: "'Cinzel',serif" } }, "COLONY FELL"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, color: "#ef4444aa", fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", maxWidth: 360, lineHeight: 1.7, animation: "fadeIn 1.5s ease-out" } }, defeatData.line), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, fontFamily: "system-ui", fontSize: 13, color: "#666", animation: "fadeIn 2s ease-out" } }, /* @__PURE__ */ React.createElement("span", null, "Night ", ante), /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, defeatData.blind)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, alignItems: "baseline", animation: "fadeIn 2s ease-out" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 28, fontWeight: 900, color: "#ef4444bb" } }, defeatData.score.toLocaleString()), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "#555", fontFamily: "system-ui" } }, " / ", defeatData.target.toLocaleString(), " threshold")), fallen.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center", animation: "fadeIn 2.5s ease-out" } }, fallen.map((f, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { fontSize: 10, color: BREEDS[f.breed]?.color || "#888", fontFamily: "system-ui", opacity: 0.5 } }, f.name.split(" ")[0]))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setDefeatData(null);
      setPh("gameOver");
  ...
  if (ph === "gameOver" || ph === "victory") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", zIndex: 1, gap: 12, padding: 20, maxWidth: 550 } }, vStep === 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, animation: "comboBurst .8s ease-out" } }, won ? isNinthDawn ? "\u{1F305}" : "\u{1F451}" : "\u{1F480}"), /* @__PURE__ */ React.createElement("h2", { style: { fontSize: won && isNinthDawn ? 42 : 28, letterSpacing: won && isNinthDawn ? 12 : 6, margin: 0, color: won ? void 0 : "#ef4444", background: won ? "linear-gradient(135deg,#f59e0b,#fef08a)" : void 0, WebkitBackgroundClip: won ? "text" : void 0, WebkitTextFillColor: won ? "transparent" : void 0, animation: "comboBurst .6s ease-out", fontFamily: "'Cinzel',serif" } }, won ? isNinthDawn ? "DAWN" : "THEY MADE IT" : "THE DARK WON"), won && !isNinthDawn && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2466", fontStyle: "italic", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 1.5s ease-out", marginTop: 4, textAlign: "center", maxWidth: 340 } }, breath);
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#fbbf24cc", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 360, lineHeight: 1.7, animation: "fadeIn 2s ease-out .5s both", padding: "10px 16px", borderRadius: 10, background: "#fbbf2406", border: "1px solid #fbbf2418" } }, hookText);
    })(), won && !isNinthDawn && meta && meta.stats.w > 1 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#fbbf2444", fontStyle: "italic", fontFamily: "'Cinzel',serif", letterSpacing: 2, animation: "fadeIn 2s ease-out .5s both" } }, "The fire burns brighter. Colony #", (meta.stats.r || 0) + 1, "."), won && isNinthDawn && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#fbbf24aa", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 360, lineHeight: 1.7, animation: "fadeIn 2s ease-out" } }, "Nine colonies. One survived. Not because it was the strongest. Because someone remembered all the rest."), !won && (() => {
    ...
    } }))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, animation: "float 3s ease-in-out infinite", filter: "drop-shadow(0 0 30px #fbbf2444)", marginBottom: 4 } }, "\u{1F525}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 900, letterSpacing: 8, fontFamily: "'Cinzel',serif", background: "linear-gradient(135deg,#f59e0b,#fef08a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", animation: "comboBurst .8s ease-out" } }, "THE FOUNDING"), /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 24px", borderRadius: 14, background: "linear-gradient(145deg,#fbbf2408,#c084fc06)", border: "1.5px solid #fbbf2433", textAlign: "center", maxWidth: 380, animation: "fadeIn 1.5s ease-out .5s both", boxShadow: "0 0 40px #fbbf2418" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#fbbf24cc", fontFamily: "system-ui", lineHeight: 1.8, marginBottom: 10 } }, "A colony survived three nights. For the first time since the eighth colony fell, someone kept a fire burning through the dark. Two names go into the Hearth. Not as memories. As ", /* @__PURE__ */ React.createElement("b", { style: { color: "#fef08a" } }, "founders"), ". Everything that comes after carries their blood."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#c084fcbb", fontFamily: "system-ui", fontStyle: "italic", lineHeight: 1.6 } }, "The dark gave you three nights to see if you were worth five. You were.")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap", fontSize: 10, fontFamily: "system-ui", animation: "fadeIn 2s ease-out 1s both" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24", padding: "4px 10px", borderRadius: 6, background: "#fbbf2411", border: "1px solid #fbbf2422" } }, "5 Nights Unlocked"), /* @__PURE__ */ React.createElement("span", { style: { color: "#c084fc", padding: "4px 10px", borderRadius: 6, background: "#c084fc11", border: "1px solid #c084fc22" } }, "\u{1F3E0} The Hearth"), /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80", padding: "4px 10px", borderRadius: 6, background: "#4ade8011", border: "1px solid #4ade8022" } }, "\u2726 Upgrades"))), meta && meta.stats.w === 2 && !isFirstRun && MX >= 5 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, right: 0, height: "100vh", pointerEvents: "none", zIndex: 0, overflow: "hidden" } }, Array.from({ length: 30 }).map((_, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: {
      position: "absolute",
      top: -10,
      left: `${3 + i * 3.2}%`,
      width: 5,
    ...
    } }))), /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 24px", borderRadius: 14, background: "linear-gradient(145deg,#fbbf2410,#f59e0b08)", border: "2px solid #fbbf2444", animation: "comboBurst .8s ease-out", textAlign: "center", maxWidth: 380, boxShadow: "0 0 40px #fbbf2422" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 900, letterSpacing: 6, marginBottom: 8, fontFamily: "'Cinzel',serif", background: "linear-gradient(135deg,#f59e0b,#fef08a)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" } }, "THE DARK LOST"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#fbbf24cc", fontFamily: "system-ui", lineHeight: 1.7, marginBottom: 10 } }, "Five nights. Every test. Every boss. Every pattern the dark has run on eight colonies. And you walked through all of it. The Hearth burns with ", meta.cats.length, " name", meta.cats.length !== 1 ? "s" : "", ". The system doesn't know what to do with that."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf2488", fontFamily: "system-ui", fontStyle: "italic" } }, "Heat is unlocked. The dark adapts. So can you."))), /* @__PURE__ */ React.createElement("button", { onClick: () => setVictoryStep(3), style: { ...BTN("linear-gradient(135deg,#fbbf24,#f59e0b)", "#0a0a1a"), padding: "10px 36px", fontSize: 14, marginTop: 8 } }, "Continue")), vStep === 3 && /* @__PURE__ */ React.createElement(React.Fragment, null, hasHearthPick && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { width: "100%", textAlign: "center" } }, isFirstHearthSave && picked.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#c084fcbb", fontFamily: "system-ui", fontStyle: "italic", lineHeight: 1.6, marginBottom: 10, maxWidth: 360, margin: "0 auto 10px", padding: "10px 14px", borderRadius: 10, background: "#c084fc06", border: "1px solid #c084fc15" } }, "The Hearth has been dark since the eighth colony fell. Two names will relight it. Not as memories. As founders. Their blood flows through every colony that comes after."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#fbbf24", letterSpacing: 3, marginBottom: 4, fontFamily: "'Cinzel',serif" } }, picked.length === 0 ? isFirstHearthSave ? "THE FOUNDERS" : "CHOOSE THE FIRST SOUL" : "CHOOSE THEIR MATE"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fcbb", fontFamily: "system-ui", marginBottom: 6 } }, picked.length === 0 ? isFirstHearthSave ? "Choose carefully. This is the beginning of everything." : "A male and female carry the story to the Hearth. Their descendants begin the next colony." : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24", fontWeight: 700 } }, getFullName(picked[0])), ` (${picked[0].sex === "M" ? "\u2642" : "\u2640"}) ${isFirstHearthSave ? "is the first Founder" : "will be remembered"}. Now choose ${isFirstHearthSave ? "the second Founder" : needSex === "M" ? "a male companion" : "a female companion"}.`)), noMate && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fb923c", fontFamily: "system-ui", marginBottom: 8 } }, "No ", needSex === "M" ? "males" : "females", " survived. ", picked[0].name.split(" ")[0], " goes alone.", /* @__PURE__ */ React.createElement("button", { onClick: async () => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: c.id, onClick: () => saveCatM(c), style: { cursor: "pointer", textAlign: "center", padding: 5, borderRadius: 8, border: "1px solid #ffffff0a", background: "#ffffff04", width: 96 } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true, hl: c.id === mvp?.id }), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 3, fontFamily: "system-ui", fontSize: 10, lineHeight: 1.4 } }, /* @__PURE__ */ React.createElement("div", { style: { color: c.sex === "M" ? "#60a5fa" : "#f472b6", fontWeight: 700 } }, c.sex === "M" ? "\u2642" : "\u2640"), c.stats.tp > 0 ? /* @__PURE__ */ React.createElement("div", { style: { color: "#888" } }, c.stats.tp, "x Best:", c.stats.bs.toLocaleString()) : /* @__PURE__ */ React.createElement("div", { style: { color: "#555", fontStyle: "italic" } }, "Never played"), /* @__PURE__ */ React.createElement("div", { style: { color: "#c084fc", fontWeight: 700, fontSize: 10 } }, "+", hVal, "\u2726/run"), c.id === mvp?.id && c.stats.tp > 0 && /* @__PURE__ */ React.createElement("div", { style: { color: "#fbbf24", fontWeight: 700, fontSize: 10 } }, "\u2605 MVP")));
  ...
  if (ph === "denSelect") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", minHeight: "100vh", zIndex: 1, gap: 10, padding: mob2 ? "16px 12px" : "20px", maxWidth: 600, paddingTop: mob2 ? 40 : 60 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: mob2 ? 18 : 20, color: campMode ? "#fbbf24" : "#c084fc", letterSpacing: 4, margin: 0, fontFamily: "'Cinzel',serif" } }, campMode ? "\u{1F3D5} CAMP" : "THE DEN"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: mob2 ? 11 : 12, color: "#ffffff55", fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", maxWidth: 320, lineHeight: 1.6 } }, campMode ? "Pick 2 cats for the watch. The rest sleep by the fire." : nightText), campMode ? /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", borderRadius: 10, background: "#fbbf2408", border: "1px solid #fbbf2422", fontSize: 12, fontFamily: "system-ui", color: "#fbbf24cc", lineHeight: 1.7, textAlign: "center", maxWidth: 380, animation: "fadeIn .6s ease-out" } }, /* @__PURE__ */ React.createElement("b", null, "Pick 2 cats for the watch."), " Unbonded \u2642+\u2640 may bond. Grudged pairs may reconcile. Others gain +1 Power.") : !seen.den && /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 14px", borderRadius: 10, background: "#c084fc08", border: "1px solid #c084fc22", fontSize: 12, fontFamily: "system-ui", color: "#c084fccc", lineHeight: 1.7, textAlign: "center", maxWidth: 380, animation: "fadeIn .6s ease-out" } }, /* @__PURE__ */ React.createElement("b", null, "Shelter a \u2642 + \u2640 pair to breed safely."), " Everyone else enters the wilds \u2014 they train, bond, or fight.", /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setSeen((s) => ({ ...s, den: true })), style: { fontSize: 10, background: "none", border: "1px solid #c084fc33", borderRadius: 4, color: "#c084fc", cursor: "pointer", padding: "3px 10px", fontFamily: "system-ui" } }, "Got it"))), campMode ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 480 } }, den.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "center", alignItems: "center", marginBottom: 8, padding: "8px 12px", borderRadius: 10, background: "#fbbf2408", border: "1px solid #fbbf2422" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf24", letterSpacing: 2, fontWeight: 700 } }, "\u{1F525} THE WATCH"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4 } }, den.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, onClick: () => toggleDen(c), style: { cursor: "pointer" } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true, cw: denCardW, sel: true }))))), den.length < 2 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2466", fontFamily: "system-ui", textAlign: "center", marginBottom: 6 } }, den.length === 0 ? "Tap 2 cats below" : "Pick 1 more"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", justifyContent: "center" } }, (() => {
    ...
    })()), injured.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fb923c88", letterSpacing: 1, fontFamily: "system-ui", marginBottom: 3 } }, "\u{1FA79} RESTING (", injured.length, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center" } }, injured.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, style: { position: "relative" } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true, cw: denCardW, dis: true }))))))) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: mob2 ? "column" : "row", gap: 12, width: "100%" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, padding: "8px 10px", borderRadius: 10, background: "#4ade8006", border: "1px solid #4ade8022", minHeight: mob2 ? 80 : 120 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: campMode ? "#fbbf24" : "#4ade80", letterSpacing: 2, fontWeight: 700, marginBottom: 6 } }, campMode ? "\u{1F525} THE WATCH" : "\u{1F6E1} SHELTER", " (", isolated.length, "/", MAX_ISOLATE, ")"), eventDenSafe && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80aa", fontFamily: "system-ui", marginBottom: 4 } }, "\u{1F54A}\uFE0F Shrine protection active"), isolated.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade8044", fontFamily: "system-ui", fontStyle: "italic" } }, "Tap cats below to shelter them") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap", justifyContent: "center" } }, isolated.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, onClick: () => toggleDen(c), style: { cursor: "pointer", position: "relative" } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true, cw: denCardW, sel: true, onTraitClick: (ct) => setTraitTip(ct) })))), !campMode && (() => {
      let breedPairs = 0;
      ...
      return breedPairs > 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui", textAlign: "center", marginTop: 4 } }, "\u{1F91D} ", breedPairs, " breeding pair", breedPairs > 1 ? "s" : "") : isolated.length >= 2 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade8066", fontFamily: "system-ui", textAlign: "center", marginTop: 4 } }, "No M/F pairs to breed") : null;
    ...
    })()), injured.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fb923c88", letterSpacing: 1, fontFamily: "system-ui", marginBottom: 3 } }, "\u{1FA79} RESTING (", injured.length, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, flexWrap: "wrap" } }, injured.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.id, style: { position: "relative" } }, /* @__PURE__ */ React.createElement(CC, { cat: c, sm: true, cw: denCardW, dis: true, onTraitClick: (ct) => setTraitTip(ct) }))))))), (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4, marginTop: 4 } }, campMode && campHint && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: campHintColor, fontFamily: "system-ui", letterSpacing: 1, animation: "fadeIn .3s ease-out" } }, campHint), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: campMode ? () => {
        const results = [];
        [setHand, setDraw, setDisc].forEach((s) => {
  ...
  if (ph === "denResults" && denRes) {
    ...
    const beats = [];
    denRes.forEach((r) => {
      if (r.type === "breed") beats.push({ pri: 0, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { width: "100%", padding: mob2 ? "8px 10px" : "10px 14px", borderRadius: 10, background: "linear-gradient(145deg,#1b2e1b,#0d0d1a)", border: "1px solid #4ade8044" } }, /* @__PURE__ */ React.createElement("div", { style: { fontStyle: "italic", color: "#4ade80bb", fontSize: 12, lineHeight: 1.5, fontFamily: "system-ui", marginBottom: 6 } }, cpk(flavorCache, `breed_${r.baby.id}`, DEN_BREED, (fn) => fn(n(r.c1), n(r.c2), n(r.baby)))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } }, /* @__PURE__ */ React.createElement(CC, { cat: r.c1, sm: true }), /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80bb" } }, "+"), /* @__PURE__ */ React.createElement(CC, { cat: r.c2, sm: true }), /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80bb" } }, "="), /* @__PURE__ */ React.createElement(CC, { cat: r.baby, sm: true, hl: true }), r.twins && r.twin2 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24bb" } }, "+"), /* @__PURE__ */ React.createElement(CC, { cat: r.twin2, sm: true, hl: true }))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", marginTop: 3 } }, BREEDS[r.baby.breed].icon, " ", r.baby.name, " P", r.baby.power, " ", (r.baby.trait || PLAIN).icon, " ", (r.baby.trait || PLAIN).name, " ", r.baby.sex === "M" ? "\u2642" : "\u2640", (r.baby.trait || PLAIN).tier !== "common" && (r.baby.trait || PLAIN).name !== "Plain" && /* @__PURE__ */ React.createElement("span", { style: { color: traitTierLabel(r.baby.trait).color, fontWeight: 700 } }, " \u2605 ", traitTierLabel(r.baby.trait).label.toUpperCase()))) });
      if (r.type === "death") beats.push({ pri: 1, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { width: "100%", padding: mob2 ? "8px 10px" : "10px 14px", borderRadius: 10, background: "linear-gradient(145deg,#2e1111,#0d0d1a)", border: "1px solid #ef4444bb" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444", letterSpacing: 3, fontWeight: 700, fontFamily: "system-ui", marginBottom: 4 } }, "\u{1F480} DEATH"), /* @__PURE__ */ React.createElement("div", { style: { fontStyle: "italic", color: "#ef4444bb", fontSize: 13, lineHeight: 1.5, fontFamily: "system-ui", marginBottom: 6 } }, cpk(flavorCache, `death_${r.victim.id}`, DEN_DEATH, (fn) => fn(n(r.c1), n(r.c2), n(r.victim)))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "8px 12px", borderRadius: 8, background: "#ef444411", border: "1px solid #ef444422" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#ef4444", fontWeight: 700 } }, r.victim.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", marginTop: 2 } }, "P", r.victim.power, " ", BREEDS[r.victim.breed]?.icon, " ", r.victim.breed, " ", (r.victim.trait || PLAIN).icon, " ", (r.victim.trait || PLAIN).name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444bb", fontFamily: "system-ui", marginTop: 2 } }, r.victim.stats?.tp > 0 ? `Played ${r.victim.stats.tp} hands. Best: ${r.victim.stats.bs?.toLocaleString()}.` : "Never got to play."), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444", fontFamily: "system-ui", marginTop: 4, fontWeight: 700, letterSpacing: 2 } }, "Gone from the colony."))) });
      if (r.type === "phoenix") beats.push({ pri: 0, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { width: "100%", padding: mob2 ? "8px 10px" : "10px 14px", borderRadius: 10, background: "linear-gradient(145deg,#2e2211,#0d0d1a)", border: "1px solid #fbbf2466" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "#fbbf24", fontWeight: 700, marginBottom: 4 } }, "\u{1F525} ", n(r.risen), " RISES FROM THE ASHES!"), /* @__PURE__ */ React.createElement("div", { style: { fontStyle: "italic", color: "#fbbf24bb", fontSize: 11, fontFamily: "system-ui" } }, cpk(flavorCache, `phoenix_${r.risen.id}`, DEN_PHOENIX, (fn) => fn(r.c1.name, r.c2.name, r.risen.name))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf24", fontFamily: "system-ui", marginTop: 4 } }, "Now Eternal at P1. The fire changes everything.")) });
      if (r.type === "bond") beats.push({ pri: 2, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#f472b6", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F495} ", n(r.c1), " & ", n(r.c2), " bonded ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 ", bondStr, " mult together")) });
      if (r.type === "reconcile_bond") beats.push({ pri: 2, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#f472b6", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F495} ", n(r.c1), " & ", n(r.c2), " reconciled + bonded ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 ", bondStr, " mult together")) });
      if (r.type === "reconcile") beats.push({ pri: 2, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#67e8f9", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F54A}\uFE0F ", n(r.c1), " & ", n(r.c2), " made peace ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 grudge cleared")) });
      if (r.type === "fight") beats.push({ pri: 3, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#ef4444", lineHeight: 1.4, padding: "4px 0" } }, "\u2694 ", n(r.loser), " ", r.wasInjured ? "injured" : "scarred", " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 ", r.wasInjured ? "heals in 2 rounds" : "\xD71.25 mult")) });
      if (r.type === "grudge") beats.push({ pri: 3, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#fb923c", lineHeight: 1.4, padding: "4px 0" } }, "\u26A1 ", n(r.c1), " & ", n(r.c2), " grudge ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 \u22122M when together")) });
      if (r.type === "wanderer") beats.push({ pri: 4, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#67e8f9", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F431} ", n(r.cat), " wandered in ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 P", r.cat.power, " ", r.cat.breed)) });
      if (r.type === "growth") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#4ade80", lineHeight: 1.4, padding: "4px 0" } }, "\u2B50 ", n(r.cat), " +1P") });
      if (r.type === "mentor") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#c084fc", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F4D6} ", n(r.elder), " mentored ", n(r.young), " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 +1P")) });
      if (r.type === "training") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#60a5fa", lineHeight: 1.4, padding: "4px 0" } }, "\u2694\uFE0F ", n(r.c1), " & ", n(r.c2), " sparred ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 +1P each")) });
      if (r.type === "teach") beats.push({ pri: 4, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#34d399", fontWeight: 700, lineHeight: 1.4, padding: "4px 0" } }, "\u{1F46A} ", n(r.parent), " taught ", n(r.child), " ", r.trait.icon, " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55" } }, "\u2014 ", r.trait.name)) });
      if (r.type === "found") beats.push({ pri: 5, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#fbbf24", lineHeight: 1.4, padding: "4px 0" } }, "\u{1F41F} ", n(r.cat), " found ", r.gold, "\u{1F41F}") });
      if (r.traitGained) beats.push({ pri: 4, el: /* @__PURE__ */ React.createElement("div", { key: beats.length, style: { fontSize: 11, fontFamily: "system-ui", color: "#fbbf24", fontWeight: 700, lineHeight: 1.4, padding: "4px 0" } }, "\u2728 ", n(r.traitGained.cat), " gained ", r.traitGained.trait.icon, " ", r.traitGained.trait.name) });
    });
    beats.sort((a, b) => a.pri - b.pri);
    const majors = beats.filter((b) => b.pri <= 1);
    const minors = beats.filter((b) => b.pri >= 2);
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", minHeight: "100vh", zIndex: 1, gap: 10, padding: mob2 ? "16px 12px" : "20px", maxWidth: 550, overflowY: "auto", paddingTop: mob2 ? 30 : 40 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: mob2 ? 16 : 18, color: "#c084fc", letterSpacing: 4, margin: 0, fontFamily: "'Cinzel',serif", animation: "fadeIn .6s ease-out" } }, "WHAT HAPPENED IN THE DARK"), denRes.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { color: "#666", fontSize: 13, fontStyle: "italic", fontFamily: "system-ui", textAlign: "center", lineHeight: 1.6, maxWidth: 340 } }, cpk(flavorCache, "denQuiet", DEN_QUIET, (fn) => fn())), majors.map((b, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { width: "100%", animation: `scoreSlide .5s ease-out ${i * 0.6}s both` } }, b.el)), minors.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 1, width: "100%", maxWidth: 420, padding: "8px 12px", borderRadius: 10, background: "#ffffff04", border: "1px solid #ffffff08", animation: `fadeIn .5s ease-out ${majors.length * 0.6 + 0.3}s both` } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc88", letterSpacing: 4, textAlign: "center", fontFamily: "system-ui", fontWeight: 700, marginBottom: 4 } }, "DEN REPORT"), minors.map((b, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { animation: `scoreSlide .3s ease-out ${majors.length * 0.6 + 0.5 + i * 0.15}s both` } }, b.el))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      const babies = [];
  ...
  if (ph === "shop") {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: W }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement(Dust, null), /* @__PURE__ */ React.createElement("style", null, CSS), toasts.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 250, display: "flex", flexDirection: "column", gap: 6, pointerEvents: "none", maxWidth: 280 } }, toasts.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", gap: 8, alignItems: "center", padding: t.big ? "12px 18px" : "8px 14px", borderRadius: t.big ? 10 : 8, background: "#1a1a2eee", border: `1.5px solid ${t.color}${t.big ? "66" : "44"}`, boxShadow: `0 4px 16px #00000066,0 0 ${t.big ? 16 : 8}px ${t.color}${t.big ? "44" : "22"}`, animation: "slideIn .3s ease-out", fontFamily: "system-ui" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 22 : 16, flexShrink: 0 } }, t.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 14 : 12, color: t.color, fontWeight: t.big ? 700 : 600, lineHeight: 1.3 } }, t.text)))), /* @__PURE__ */ React.createElement("div", { style: { width: "100%", maxWidth: 700, padding: "10px 16px", zIndex: 1, display: "flex", flexDirection: "column", gap: 8, alignItems: "center", paddingBottom: 100 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", width: "100%", alignItems: "center" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: 20, color: "#fbbf24", letterSpacing: 4, margin: 0, fontFamily: "'Cinzel',serif" } }, "THE MARKET"), /* @__PURE__ */ React.createElement(ProgressMap, { ante, blind, mx: MX })), /* @__PURE__ */ React.createElement(FM, { level: ferv, prev: pFerv }), (() => {
      ...
      }, style: { flex: 1, padding: vw < 500 ? "12px 4px" : "8px 4px", fontSize: 12, fontFamily: "system-ui", fontWeight: shopTab === id ? 700 : 400, color: shopTab === id ? "#fbbf24" : isNudge ? "#fbbf24" : "#666", background: shopTab === id ? "#fbbf2408" : isNudge ? "#fbbf2406" : "transparent", border: "none", borderBottom: shopTab === id ? "2px solid #fbbf24" : isNudge ? "2px solid #fbbf2466" : "2px solid transparent", cursor: "pointer", transition: "all .2s", animation: isNudge ? "breathe 2s ease-in-out infinite" : "none" } }, label, isNudge ? " \u2726" : "");
      ...
      return Object.entries(bCounts).sort(([, a], [, b]) => b - a).map(
        ([br, ct]) => /* @__PURE__ */ React.createElement("span", { key: br, style: { fontSize: 10, color: BREEDS[br]?.color || "#888", fontFamily: "system-ui", padding: "1px 5px", borderRadius: 3, background: BREEDS[br]?.color + "11", border: "1px solid " + BREEDS[br]?.color + "22" } }, BREEDS[br]?.icon, ct)
      );
    })(), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui", padding: "1px 5px" } }, [...hand, ...draw, ...disc].length, " cats \xB7 avg P", Math.round([...hand, ...draw, ...disc].reduce((s, c) => s + c.power, 0) / Math.max(1, [...hand, ...draw, ...disc].length)))), (() => {
      ...
      } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16 } }, f.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: can ? "#fbbf24" : "#555", fontWeight: 700 } }, wp, "\u{1F41F}", f._starter ? " \u2605" : "")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: isHtWard ? "#c084fc" : "#e8e6e3cc", marginTop: 4 } }, f.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", lineHeight: 1.4, marginTop: 2 } }, f.desc), isHtWard && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc66", fontFamily: "system-ui", marginTop: 3, letterSpacing: 1 } }, "HAND TYPE BONUS"));
    })) : !ul.fams && !isFirstRun ? /* @__PURE__ */ React.createElement("div", { style: { color: "#555", fontSize: 10, fontFamily: "system-ui", fontStyle: "italic", textAlign: "center", padding: 12, marginBottom: 12 } }, "\u{1F512} Complete a run to unlock Wards") : /* @__PURE__ */ React.createElement("div", { style: { color: "#555", fontSize: 10, fontFamily: "system-ui", textAlign: "center", padding: 12, marginBottom: 12 } }, "No wards available"), fams.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", letterSpacing: 2, marginBottom: 4 } }, "EQUIPPED (", fams.length, "/", MF, ")"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap" } }, fams.map((f) => /* @__PURE__ */ React.createElement("div", { key: f.id, onClick: () => toast(f.icon, `${f.name}: ${f.desc}`, "#fbbf24"), style: { display: "flex", alignItems: "center", gap: 4, padding: "4px 8px", borderRadius: 6, background: "#ffffff06", border: "1px solid #ffffff0a", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, f.icon), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#aaa", fontFamily: "system-ui" } }, f.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#666", fontFamily: "system-ui" } }, f.desc)), /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
      e.stopPropagation();
      sellFam(f);
    }, style: { fontSize: 10, color: "#ef4444aa", background: "none", border: "none", cursor: "pointer", padding: 0, fontFamily: "system-ui" } }, "\u2715"))))), runCount >= 1 && sScrolls.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf24bb", letterSpacing: 2, marginBottom: 6 } }, "\u{1F4DC} SCROLLS"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 } }, sScrolls.map((s, i) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: s.name, onClick: () => can && buyScroll(i), style: {
        ...
        opacity: can ? 1 : 0.4,
        transition: "all .2s"
      } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#fbbf24" } }, s.name), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: can ? "#fbbf24" : "#555", fontWeight: 700 } }, s.price, "\u{1F41F}")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui", marginTop: 3 } }, "Lv", s.lv, " ", "\u2192", " Lv", s.nextLv, s.nextBase && /* @__PURE__ */ React.createElement("span", { style: { color: "#4ade80" } }, " (", s.nextBase.c, "C \xD7 ", s.nextBase.m, "M)")));
      ...
      return /* @__PURE__ */ React.createElement("div", { key: breed, style: { padding: "6px 10px", borderRadius: 8, background: dev.count > 0 ? color + "08" : "transparent", border: `1px solid ${dev.count > 0 ? color + "22" : "#ffffff08"}` } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 3 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color, fontWeight: 700, fontFamily: "system-ui" } }, icon, " ", breed), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: color + "88", fontFamily: "system-ui" } }, dev.count, " played")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, marginBottom: 4 } }, (DEVOTION_MILESTONES[breed] || []).map((m, i) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { ...W, animation: fFlash === "down" ? "shake .3s ease" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: BG }), /* @__PURE__ */ React.createElement("style", null, CSS), isNL && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, border: "2px solid #fef08a44", pointerEvents: "none", zIndex: 50, animation: "glow 2s ease-in-out infinite" } }), reshuf && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: "40%", left: "50%", transform: "translate(-50%,-50%)", zIndex: 200, animation: "flash .8s ease-out forwards", fontSize: 13, color: "#fbbf24", letterSpacing: 4, fontWeight: 700, whiteSpace: "nowrap" } }, "\u267B RESHUFFLE"), toasts.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 250, display: "flex", flexDirection: "column", gap: 6, pointerEvents: "none", maxWidth: 280 } }, toasts.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", gap: 8, alignItems: "center", padding: t.big ? "12px 18px" : "8px 14px", borderRadius: t.big ? 10 : 8, background: "#1a1a2eee", border: `1.5px solid ${t.color}${t.big ? "66" : "44"}`, boxShadow: `0 4px 16px #00000066,0 0 ${t.big ? 16 : 8}px ${t.color}${t.big ? "44" : "22"}`, animation: "slideIn .3s ease-out", fontFamily: "system-ui" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 22 : 16, flexShrink: 0 } }, t.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: t.big ? 14 : 12, color: t.color, fontWeight: t.big ? 700 : 600, lineHeight: 1.3 } }, t.text)))), autoPlay && ph === "playing" && (() => {
    ...
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#fbbf2488", letterSpacing: 4, marginBottom: 6 } }, tour.title), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#e8e6e3", lineHeight: 1.6 } }, tour.msg), /* @__PURE__ */ React.createElement("button", { onClick: () => setAutoPlay((a) => a ? { ...a, step: a.step + 1 } : null), style: { marginTop: 12, fontSize: 12, background: "linear-gradient(135deg,#fbbf24,#f59e0b)", border: "none", borderRadius: 6, color: "#0a0a1a", cursor: "pointer", padding: "8px 20px", fontWeight: 700, fontFamily: "system-ui", letterSpacing: 1 } }, step === -1 ? "Show me \u2192" : "Next \u2192"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", bottom: guide.step >= 2 ? 280 : 220, left: "50%", transform: "translateX(-50%)", zIndex: 150, padding: "10px 18px", borderRadius: 10, background: "#0a0a1aee", border: "1px solid #fbbf2444", maxWidth: 300, animation: "fadeIn .6s ease-out", textAlign: "center", fontFamily: "system-ui", boxShadow: "0 8px 32px #00000088" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#fbbf24", fontWeight: 700 } }, msg), sub && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24aa", marginTop: 2 } }, sub), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setGuide(null);
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: nph > 45e3 ? "#ef4444" : nph > 24e3 ? "#fb923c" : "#aaa", fontFamily: "system-ui", fontWeight: 700, animation: nph > 45e3 ? "fpp 2s ease infinite" : "none" } }, "\u{1F3AF} ", nph.toLocaleString(), "/hand");
  })()), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { color: "#fbbf24", fontWeight: 700, fontSize: 13 } }, "\u{1F41F}", gold), runCount >= 1 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui" } }, Math.min(5, Math.floor(gold / 5)) > 0 ? `+${Math.min(5, Math.floor(gold / 5))} stores` : "")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, alignItems: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
    e.stopPropagation();
    toggleMute();
    ...
    const nph = Math.ceil((tgt - rScore) / hLeft);
    return /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "3px 0", zIndex: 1, maxWidth: 700, width: "100%" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: nph > 45e3 ? "#ef4444" : nph > 24e3 ? "#fb923c" : "#aaa", fontFamily: "system-ui", fontWeight: 800, letterSpacing: 1 } }, "\u{1F3AF} ", nph.toLocaleString(), " per hand"));
  ...
  }, style: { fontSize: 10, color: "#fbbf2466", fontFamily: "system-ui", cursor: "pointer", animation: "breathe 2s ease-in-out infinite", marginRight: 2 } }, "\u2139\uFE0F"), runCount >= 1 && Object.keys(DEVOTION_MILESTONES).map((breed) => {
    const dev = getDevotionLevel(breed, devotion);
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: "12%", left: 0, right: 0, zIndex: 102, pointerEvents: "none", textAlign: "center", animation: "multFlash .7s ease-out forwards" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, color: srcColor, fontFamily: "system-ui", letterSpacing: 3, fontWeight: 700, marginBottom: 8, textShadow: `0 0 20px ${srcColor}44` } }, multPop.label), /* @__PURE__ */ React.createElement("div", { style: {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      } }, displayPrimary, displayCombo ? /* @__PURE__ */ React.createElement("span", { style: { color: "#c084fc" } }, " + ", displayCombo) : ""), htLvMatch && !done && /* @__PURE__ */ React.createElement("span", { style: { fontSize: isReveal ? 13 : 11, fontWeight: 700, color: "#fbbf24", background: "#fbbf2418", padding: isReveal ? "3px 9px" : "2px 7px", borderRadius: 6, fontFamily: "system-ui", letterSpacing: 1, border: "1px solid #fbbf2433", animation: isReveal ? "fadeIn .8s ease-out" : "none" } }, "LV", htLvMatch[1])), !isReveal && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: done ? 2 : 4 } }), anyDisc && done && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#c084fc", fontWeight: 700, letterSpacing: 2, fontFamily: "system-ui", animation: "fadeIn .5s ease-out", marginBottom: 4 } }, "\u2728 SECRET COMBO DISCOVERED \u2728"), done && !anyDisc && (() => {
        const eo = htObj?.echo;
        return eo ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff66", fontStyle: "italic", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 1s ease-out", marginBottom: 2 } }, eo) : null;
      })());
    })(), (() => {
      const isReveal = sStep === -1;
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", animation: isFirstStep ? "fadeIn .4s ease-out" : "none" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", transition: "transform .2s", transform: (isChipStep || isFirstStep) && !done ? "scale(1.2)" : "scale(1)" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6", fontWeight: 900, fontSize: done ? 26 : 22, transition: "font-size .2s", textShadow: (isChipStep || isFirstStep) && !done ? "0 0 12px #3b82f644" : "none", animation: isFirstStep ? "countUp .4s ease-out" : "none" } }, displayChips), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#3b82f666", fontFamily: "system-ui", letterSpacing: 2 } }, "CHIPS")), /* @__PURE__ */ React.createElement("span", { style: { color: "#ffffff55", fontSize: 16, fontFamily: "'Cinzel',serif" } }, "\xD7"), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", transition: "transform .2s", transform: (isMultStep || isFirstStep) && !done ? "scale(1.2)" : "scale(1)" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444", fontWeight: 900, fontSize: done ? 26 : 22, transition: "font-size .2s", textShadow: (isMultStep || isFirstStep) && !done ? "0 0 12px #ef444444" : "none", animation: isFirstStep ? "countUp .4s ease-out" : "none" } }, displayMult), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef444466", fontFamily: "system-ui", letterSpacing: 2 } }, "MULT")), /* @__PURE__ */ React.createElement("span", { style: { color: "#ffffff55", fontSize: 16, fontFamily: "'Cinzel',serif" } }, "="), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("span", { style: {
        fontWeight: 900,
        fontSize: done ? 38 : 28,
        color: counterColor,
        ...
        transition: "all .15s",
        fontFamily: "system-ui"
      } }, displayTotal.toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: counterColor + "44", fontFamily: "system-ui", letterSpacing: 2 } }, "SCORE")));
    })(), !done && s?.reason && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: stepColor + "cc", fontFamily: "system-ui", letterSpacing: 0.5, marginTop: 1, animation: "fadeIn .15s ease-out", maxWidth: 280, textAlign: "center", lineHeight: 1.3 } }, s.reason), !done && flavor && !s?.reason && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: counterColor + "bb", fontFamily: "system-ui", fontStyle: "italic", letterSpacing: 1.5, marginTop: 2, animation: "fadeIn .15s ease-out", maxWidth: 260, textAlign: "center", lineHeight: 1.3 } }, flavor), !done && annotation && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui", marginTop: 4, padding: "3px 12px", borderRadius: 8, background: "#4ade800a", border: "1px solid #4ade8022", animation: "fadeIn .3s ease-out", maxWidth: 280, textAlign: "center", lineHeight: 1.4, letterSpacing: 0.5 } }, "\u{1F4A1} ", annotation), s && !done && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 2, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 1 } }, s.type === "hand" || s.type === "combo" ? /* @__PURE__ */ React.createElement(React.Fragment, null, (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4, animation: shakeAnim } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: {
        ...
        return lvMatch ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: rarity >= 4 ? 14 : 12, fontWeight: 700, color: htColor, background: `${htColor}18`, padding: "2px 8px", borderRadius: 6, fontFamily: "system-ui", letterSpacing: 1, border: `1px solid ${htColor}33` } }, "LV", lvMatch[1]) : null;
    ...
    })(), s.type !== "hand" && s.type !== "combo" && !hasX && (s.chips || s.mult) ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontFamily: "system-ui", fontWeight: 700, display: "flex", gap: 6 } }, s.chips > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6" } }, "+", s.chips), s.mult > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, "+", s.mult), s.mult < 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, s.mult)) : null)), done && /* @__PURE__ */ React.createElement("div", { style: { width: 200, height: 6, background: "#ffffff0a", borderRadius: 3, overflow: "hidden", marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: {
      height: "100%",
      width: `${pct}%`,
      borderRadius: 3,
    ...
    } })), done && pct >= 100 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#4ade80", fontFamily: "system-ui", letterSpacing: 4, fontWeight: 900, animation: "comboBurst .6s ease-out", marginTop: 4, textShadow: "0 0 16px #4ade8066" } }, "TARGET PASSED \u2726"), done && pct < 100 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#ef4444", fontFamily: "system-ui", letterSpacing: 3, fontWeight: 900, animation: "fpp 1.5s ease infinite", marginTop: 4 } }, "BELOW THRESHOLD"), !done && nearMiss && pct < 100 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444aa", fontFamily: "system-ui", letterSpacing: 2, animation: "fpp 1.5s ease infinite", marginTop: 2 } }, "CLOSE..."), done && tier?.label && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", animation: "tierReveal .5s ease-out", marginTop: 4 } }, /* @__PURE__ */ React.createElement("div", { style: {
      fontSize: 20,
      fontWeight: 900,
      letterSpacing: 8,
      color: tier.color,
      ...
      fontFamily: "'Cinzel',serif"
    } }, tier.label), tier.sub && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: tier.color, opacity: 0.7, letterSpacing: 3, fontFamily: "system-ui", marginTop: 2 } }, tier.sub), tier.nar && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "#aaa", fontStyle: "italic", fontFamily: "system-ui", marginTop: 3, opacity: 0.7 } }, tier.nar)), done && newBest && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: "#fbbf24", letterSpacing: 3, animation: "newBestPop .5s ease-out", fontFamily: "system-ui", background: "#fbbf2418", padding: "3px 12px", borderRadius: 20, border: "1px solid #fbbf2433", marginTop: 4 } }, "NEW BEST ", newBest.toUpperCase()), done && _fc && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#4ade80", fontFamily: "system-ui", marginTop: 6, padding: "8px 16px", borderRadius: 8, background: "#4ade800a", border: "1px solid #4ade8022", animation: "fadeIn .6s ease-out .3s both", maxWidth: 320, textAlign: "center", lineHeight: 1.6 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 700, marginBottom: 4 } }, "Chips \xD7 Mult = Score"), /* @__PURE__ */ React.createElement("div", { style: { color: "#4ade80bb", fontSize: 10 } }, "Each cat's ", /* @__PURE__ */ React.createElement("span", { style: { color: "#3b82f6" } }, "Power adds Chips"), ". Traits and bonds add ", /* @__PURE__ */ React.createElement("span", { style: { color: "#ef4444" } }, "Mult"), ". More same-season cats = stronger hand type = bigger base numbers. Stack everything.")));
  })(), /* @__PURE__ */ React.createElement("div", { style: { height: scoringDone ? 8 : 16 } }), !scoringDone && sStep >= 2 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui", letterSpacing: 2, animation: "fadeIn 1.5s ease-out" } }, "TAP TO SKIP \u23ED"), scoringDone && /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
    e.stopPropagation();
    advanceFromScoring();
  }, style: { background: "linear-gradient(135deg,#fbbf24,#f59e0b)", color: "#0a0a1a", border: "none", borderRadius: 10, padding: "10px 32px", fontSize: 13, fontWeight: 700, cursor: "pointer", letterSpacing: 1, fontFamily: "system-ui", boxShadow: "0 0 24px #fbbf2444", animation: "fadeIn .3s ease-out" } }, "Continue"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: mob ? 4 : 8, justifyContent: "center", alignItems: "flex-start", padding: "4px 8px", flexWrap: "wrap", maxWidth: "100%", opacity: sStep < 0 ? 0 : 1, transition: "opacity .3s", animation: sStep === 0 ? "fadeIn .4s ease-out" : "none" } }, scoringCats.map((cat, ci) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24", textAlign: "center", fontFamily: "system-ui", lineHeight: 1.4 } }, "\u{1F3F7}\uFE0F ", /* @__PURE__ */ React.createElement("b", null, '"', traitTip.epithet, '"'), epDef?.desc ? /* @__PURE__ */ React.createElement("span", { style: { color: "#fbbf24aa" } }, " \u2014 ", epDef.desc) : "");
  })(), traitTip.bondedTo && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#f472b6", textAlign: "center", fontFamily: "system-ui" } }, "\u{1F495} Bonded. \xD71.5 mult", traitTip.epithetKey === "bonded" ? " (+2 from epithet)" : "", ", \xD71.25 for second pair"), (traitTip.grudgedWith || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fb923c", textAlign: "center", fontFamily: "system-ui" } }, "\u26A1 ", (traitTip.grudgedWith || []).length, " Grudge", (traitTip.grudgedWith || []).length > 1 ? "s" : "", ". 75% tension / 25% prove per pair"), traitTip.epithetKey === "grudgeResolved" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#4ade80", textAlign: "center", fontFamily: "system-ui" } }, "\u{1F54A}\uFE0F Immune to future grudges"), traitTip.scarred && !traitTip.injured && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24", textAlign: "center", fontFamily: "system-ui" } }, "\u2694 Battle-Hardened. \xD71.25 mult"), traitTip.injured && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#ef4444", textAlign: "center", fontFamily: "system-ui" } }, "\u{1FA79} Injured. Half power, less mult (heals in ", traitTip.injuryTimer || 1, ")"), traitTip._hearthChild && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24aa", textAlign: "center", fontFamily: "system-ui" } }, "\u{1F525} Hearth Legend. Cannot be saved back.")), (traitTip.story || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, padding: "8px 12px", borderRadius: 8, background: "#ffffff04", border: "1px solid #ffffff08" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#666", letterSpacing: 2, marginBottom: 4 } }, "STORY"), (traitTip.story || []).slice(-3).map((s, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: 11, color: "#999", fontFamily: "system-ui", lineHeight: 1.5 } }, s))), traitTip.stats && traitTip.stats.tp > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, display: "flex", gap: 10, justifyContent: "center", fontSize: 10, fontFamily: "system-ui", color: "#666" } }, /* @__PURE__ */ React.createElement("span", null, "\u25B6 ", traitTip.stats.tp, " plays"), traitTip.stats.bs > 0 && /* @__PURE__ */ React.createElement("span", null, "\u{1F3C6} Best: ", traitTip.stats.bs.toLocaleString()), (() => {
  ...
  })()))), clutch && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", background: "radial-gradient(circle,#fbbf2422,transparent 60%)", pointerEvents: "none" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 32, fontWeight: 900, color: "#fbbf24", letterSpacing: 8, textShadow: "0 0 40px #fbbf24cc", animation: "clutchBurst .6s ease-out", fontFamily: "'Cinzel',serif" } }, "THEY SHOULD HAVE STAYED DOWN")), /* @__PURE__ */ React.createElement("div", { style: { minHeight: 36, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", zIndex: 1, gap: 2 } }, preview ? (() => {
    if (blind === 2 && bossTraits.some((bt) => bt.fx.noStrength)) {
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#fbbf24", letterSpacing: 2 } }, preview.type.name), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ef4444bb", fontStyle: "italic", fontFamily: "system-ui" } }, "\u{1F441}\uFE0F Watchful. it sees your hand"));
    }
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, fontWeight: 700, color: "#fbbf24", letterSpacing: 2 } }, preview.type.name), preview.combo && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: "#c084fc", letterSpacing: 1 } }, "+ ", (meta?.stats?.dh || []).includes(preview.combo.name) ? preview.combo.name : "????"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#888", fontFamily: "system-ui" } }, baseC, "\xD7", baseM), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 900, color: tier.c, letterSpacing: 1, fontFamily: "system-ui", textShadow: `0 0 8px ${tier.c}44` } }, tier.w)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 100, height: 4, background: "#1a1a2e", borderRadius: 3, overflow: "hidden", border: "1px solid #ffffff08" } }, /* @__PURE__ */ React.createElement("div", { style: { height: "100%", width: `${tier.p}%`, borderRadius: 3, background: `linear-gradient(90deg,${tier.c}66,${tier.c})`, transition: "width .3s" } })), need > 0 && hLeft > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 700, color: ratio >= 1 ? "#4ade80" : "#ef4444", fontFamily: "system-ui", letterSpacing: 0.5 } }, "\u{1F3AF} ", Math.ceil(pacePerHand).toLocaleString(), "/hand")), sel.size > 1 && /* @__PURE__ */ React.createElement("button", { onClick: () => setSel(/* @__PURE__ */ new Set()), style: { background: "none", border: "1px solid #ffffff12", borderRadius: 4, color: "#555", fontSize: 10, cursor: "pointer", padding: "2px 8px", fontFamily: "system-ui" } }, "Clear"), hLeft <= 1 && need > 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444", fontWeight: 700, fontFamily: "system-ui", animation: "fpp 1.5s ease infinite" } }, "LAST HAND"), (() => {
      const warnings = [];
      ...
      return warnings.length > 0 ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 1 } }, warnings.map((w, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: 10, color: w.color, fontFamily: "system-ui" } }, w.icon, " ", w.text))) : null;
    })());
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, padding: "4px 16px", zIndex: 1, maxWidth: 700, width: "100%", justifyContent: "center", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3, alignItems: "flex-end" } }, ordered.map((cat, pos) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: cat.id, style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fbbf24", fontFamily: "system-ui", fontWeight: 700 } }, pos + 1), /* @__PURE__ */ React.createElement("div", { style: { width: 24, height: 28, borderRadius: 4, background: b.bg, border: `1px solid ${b.color}44`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontSize: 10 } }, /* @__PURE__ */ React.createElement("span", null, b.icon), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: b.color, fontWeight: 700 } }, cat.power)));
    })), benchTraited.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 2, alignItems: "center", padding: "2px 6px", borderRadius: 4, background: "#ffffff06", border: "1px solid #ffffff0a" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#888", fontFamily: "system-ui" } }, "\u{1FA91}"), benchTraited.slice(0, 3).map((c) => /* @__PURE__ */ React.createElement("span", { key: c.id, style: { fontSize: 10 }, title: `${c.name.split(" ")[0]}: bench bonus` }, (c.trait || {}).icon || "\xB7"))));
  })(), (() => {
    ...
    }, style: { textAlign: "center", padding: "2px 0", zIndex: 1, animation: "fadeIn .15s ease-out", cursor: "help" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#fbbf24", fontFamily: "'Cinzel',serif", letterSpacing: 2 } }, evald.name, htLv > 1 ? ` Lv${htLv}` : ""), runCount >= 1 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#3b82f6", fontFamily: "system-ui", fontWeight: 700, marginLeft: 8 } }, baseC, "C"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#ffffff55", margin: "0 2px" } }, "\xD7"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#ef4444", fontFamily: "system-ui", fontWeight: 700 } }, baseM, "M")), bonds.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#4ade80", marginLeft: 6 } }, "\u{1F495}\xD71.5"), grudges.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#fb923c", marginLeft: 6 } }, "\u26A1\u22122M"), evald.combo && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#c084fc", marginLeft: 6 } }, "+\u26A1", evald.combo.name));
  })(), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, padding: "8px", zIndex: 10, alignItems: "center", position: mob ? "sticky" : "static", bottom: mob ? 0 : "auto", background: mob ? "#0a0a1aee" : "transparent", borderTop: mob ? "1px solid #ffffff0a" : "none", justifyContent: "center" } }, ph === "playing" && hLeft <= 0 && rScore < tgt ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => endRun(false, rScore), style: { ...BTN("linear-gradient(135deg,#ef4444,#dc2626)", "#fff"), padding: mob ? "12px 24px" : "10px 20px", fontSize: 14, animation: "fpp 1.5s ease infinite" } }, "Colony Fell"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#ef4444bb", marginTop: 4, fontFamily: "system-ui" } }, "No hands remaining")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, runCount >= 1 ? (() => {
    const cost = recruitCost();
    const canRecruit = ph === "playing" && !autoPlay && gold >= cost && (draw.length > 0 || disc.length > 0);
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { onClick: recruitCat, disabled: !canRecruit, style: { ...BTN(canRecruit ? "#1a2e1a" : "#111", canRecruit ? "#4ade80" : "#444", canRecruit), border: `1px solid ${canRecruit ? "#4ade8044" : "#222"}`, minWidth: mob ? 56 : 50, padding: mob ? "10px 10px" : "8px 10px", fontSize: 10 } }, "+1 Cat"), /* @__PURE__ */ React.createElement("div", { onClick: () => toast("\u{1F431}", "Recruit: draw an extra cat into your hand. Cost doubles each time (1\u21922\u21924\u21928\u{1F41F}). More cats = better hands + bench bonuses.", "#4ade80"), style: { fontSize: 10, color: cost === 0 ? "#4ade80" : gold >= cost ? "#fbbf24" : "#ef4444", marginTop: 2, fontFamily: "system-ui", cursor: "help" } }, cost === 0 ? "Free!" : cost + "\u{1F41F}"));
  })() : null), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: discardH, disabled: !sel.size || sel.size > MAX_DISCARD || dLeft <= 0 || ph !== "playing" || cfx.noDisc, style: { ...BTN(sel.size && sel.size <= MAX_DISCARD && dLeft > 0 && ph === "playing" && !cfx.noDisc ? "#1a1a2e" : "#111", sel.size && sel.size <= MAX_DISCARD && dLeft > 0 && ph === "playing" && !cfx.noDisc ? "#ef4444" : "#444", sel.size > 0 && sel.size <= MAX_DISCARD && dLeft > 0 && ph === "playing" && !cfx.noDisc), border: `1px solid ${sel.size && sel.size <= MAX_DISCARD && dLeft > 0 && !cfx.noDisc ? "#ef444444" : "#222"}`, minWidth: mob ? 56 : 60, padding: mob ? "10px 10px" : "8px 14px" } }, "Discard", cfx.noDisc ? " \u{1F6AB}" : ""), /* @__PURE__ */ React.createElement("div", { onClick: () => toast("\u267B\uFE0F", `Discard: swap up to ${MAX_DISCARD} selected cats for new draws. Free!`, "#ef4444"), style: { fontSize: 10, color: cfx.noDisc ? "#ef4444bb" : sel.size > MAX_DISCARD ? "#ef4444" : dLeft <= 0 ? "#ef4444" : "#888", marginTop: 2, fontFamily: "system-ui", cursor: "help" } }, cfx.noDisc ? "Disabled" : sel.size > MAX_DISCARD ? `Max ${MAX_DISCARD}` : `${dLeft} left`), sel.size > 0 && dLeft > 0 && !cfx.noDisc && ph === "playing" && (() => {
    ...
    return hints.length > 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#4ade80", fontFamily: "system-ui", marginTop: 1 } }, hints.slice(0, 2).map((h, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { color: h.color } }, h.icon, h.text, " "))) : null;
  })()), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: playH, disabled: !sel.size || hLeft <= 0 || ph !== "playing" || !!autoPlay, style: { ...BTN(sel.size && ph === "playing" && !autoPlay ? "linear-gradient(135deg,#fbbf24,#f59e0b)" : "#222", sel.size && ph === "playing" && !autoPlay ? "#0a0a1a" : "#555", sel.size > 0 && ph === "playing" && !autoPlay), minWidth: mob ? 80 : 70, padding: mob ? "12px 18px" : "8px 16px", fontSize: mob ? 15 : 14, animation: hLeft === 1 && rScore < tgt ? "fpp 1.2s ease infinite" : "none", boxShadow: hLeft === 1 && rScore < tgt ? "0 0 20px #ef444488" : "none" } }, "Play", hLeft === 1 && rScore < tgt ? " \u26A0" : ""), /* @__PURE__ */ React.createElement("div", { onClick: () => toast("\u{1F0CF}", `Hands: ${hLeft} remaining this round. Each hand plays up to 5 cats. Score \u2265 threshold to clear.`, "#3b82f6"), style: { fontSize: 10, color: hLeft <= 1 && rScore < tgt ? "#ef4444" : "#888", marginTop: 2, fontFamily: "system-ui", fontWeight: hLeft <= 1 && rScore < tgt ? 900 : 400, animation: hLeft <= 1 && rScore < tgt ? "fpp 1s ease infinite" : "none", cursor: "help" } }, hLeft <= 1 && rScore < tgt ? "\u26A0 FINAL" : hLeft === 0 ? "Done" : `Hands: ${hLeft}`)), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setDeckView(true), style: { ...BTN("#1a1a2e", "#888"), border: "1px solid #ffffff12", padding: mob ? "10px 10px" : "8px 10px", fontSize: 10, minWidth: mob ? 44 : 45 } }, "Deck"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", marginTop: 2, fontFamily: "system-ui", cursor: "pointer" }, onClick: () => setHandSort((s) => s === "season" ? "power" : "season") }, handSort === "season" ? "\u2600 szn" : "\u26A1 pwr")))), meta && meta.stats.w < 3 && ph === "playing" && !autoPlay && (() => {
    ...
    const tl = traitTierLabel(t);
    return /* @__PURE__ */ React.createElement("div", { key: t.name, style: { fontSize: 10, fontFamily: "system-ui", color: tl.color } }, t.icon, " ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600 } }, t.name), " ", /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.6, fontSize: 10 } }, "(", tl.label, ")"), " ", t.desc);
  }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, paddingTop: 4, fontSize: 10, fontFamily: "system-ui", color: "#666", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", null, "\u2694 Scarred: \xD71.25 mult"), /* @__PURE__ */ React.createElement("span", null, "\u{1FA79} Injured: Half power, \u22122 mult (heals in 2 rounds)"), /* @__PURE__ */ React.createElement("span", null, "\u{1F525} Nerve: \xD71.0 to \xD72.2 (every clear +1, boss +hands remaining)")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, paddingBottom: 4, fontSize: 10, fontFamily: "system-ui", color: "#666", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", null, "\u{1F495} Bonded pair: \xD7", getMB().bondBoost ? "1.75" : "1.5", " mult (from den shelter)"), /* @__PURE__ */ React.createElement("span", null, "\u26A1 Grudge: Always \u2212", (getMB().grudgeWisdom || 0) > 0 ? "1" : "2", " mult when grudged cats play together"), /* @__PURE__ */ React.createElement("span", null, "\u{1FA91} Bench: Unplayed hand cats give passive bonuses (traits or power as chips)")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, paddingBottom: 4, fontSize: 10, fontFamily: "system-ui", color: "#666", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", null, "\u{1F4E3} Recruit: Pay \u{1F41F} to draw extra cats (1\u21922\u21924\u21928\u{1F41F}). More cards = better combos + bench"), /* @__PURE__ */ React.createElement("span", null, "\u{1F3F7}\uFE0F Epithets: Cats earn titles from events (scars, bonds, boss clears). Shown in Hearth")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, paddingBottom: 6, fontSize: 10, fontFamily: "system-ui", color: "#666", flexWrap: "wrap" } }, Object.keys(DEVOTION_MILESTONES).map((k) => /* @__PURE__ */ React.createElement("span", { key: k, style: { color: BREEDS[k]?.color || "#888" } }, BREEDS[k]?.icon, " ", k, ": Play ", k, " cats to unlock devotion bonuses"))))), showAbandon && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 8, left: 8, zIndex: 200, display: "flex", gap: 4, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#ffffff55", fontFamily: "system-ui", marginRight: 2 } }, "v0.65"), abandonConfirm ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setAbandonConfirm(false);
    setPh("title");
    setTab("play");
  }, style: { background: "#ef444433", border: "1px solid #ef4444", borderRadius: 6, fontSize: 10, cursor: "pointer", padding: "4px 10px", color: "#ef4444", fontFamily: "system-ui", animation: "fadeIn .2s ease-out" } }, "Abandon Run"), /* @__PURE__ */ React.createElement("button", { onClick: () => setAbandonConfirm(false), style: { background: "none", border: "1px solid #ffffff22", borderRadius: 6, fontSize: 10, cursor: "pointer", padding: "4px 8px", color: "#888", fontFamily: "system-ui" } }, "\u2715")) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 3 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setAbandonConfirm(true), style: { background: "#ffffff08", border: "1px solid #ffffff22", borderRadius: 8, fontSize: 11, cursor: "pointer", padding: "6px 10px", color: "#aaa", fontFamily: "system-ui", display: "flex", alignItems: "center", gap: 4 }, title: "Abandon run" }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, "\u2630"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, letterSpacing: 1 } }, "MENU")), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowLog((l) => !l), style: { background: showLog ? "#fbbf2412" : "#ffffff08", border: `1px solid ${showLog ? "#fbbf2444" : "#ffffff22"}`, borderRadius: 8, fontSize: 11, cursor: "pointer", padding: "6px 10px", color: showLog ? "#fbbf24" : "#aaa", fontFamily: "system-ui", display: "flex", alignItems: "center", gap: 4 }, title: "Run log" }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, "\u{1F4CB}"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, letterSpacing: 1 } }, "LOG")))), showLog && /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", top: 0, left: 0, bottom: 0, width: Math.min(320, vw - 40), zIndex: 250, background: "#0d1117f8", borderRight: "1px solid #ffffff15", overflowY: "auto", padding: "40px 12px 20px", animation: "slideIn .2s ease-out", fontFamily: "system-ui" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#fbbf24", letterSpacing: 3, fontWeight: 700 } }, "\u{1F4CB} RUN LOG"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowLog(false), style: { background: "none", border: "none", color: "#555", fontSize: 14, cursor: "pointer" } }, "\u2715")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "#555", marginBottom: 8 } }, "Night ", ante, " \xB7 Round ", blind + 1, "/3 \xB7 ", runLog.length, " events"), runLog.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#555", fontStyle: "italic" } }, "Nothing has happened yet.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3 } }, [...runLog].reverse().map((e, i) => {
